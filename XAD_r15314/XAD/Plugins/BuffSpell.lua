...
local Plugin = core:NewModule("buffspell")
Plugin.fullname = "Spell Buff Items"
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("potionbuffspell")
...
function Plugin:ItemInList(itemlink)
	...
	return PT:ItemInSet(itemlink, "potionbuffspell")
end
