...
local Plugin = core:NewModule("potionbuffmana")
Plugin.fullname = "Mana Buff Items"
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("potionbuffmana")
...
function Plugin:ItemInList(itemlink)
	...
	return PT:ItemInSet(itemlink, "potionbuffmana")
end
