...
local Plugin = core:NewModule("oilwizard", tempweaponbuffs)
Plugin.fullname = "Wizard Oil"
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("oilwizard")
...
function Plugin:ItemInList(itemlink, spellid)
	...
	return PT:ItemInSet(itemlink, "oilwizard")
end
