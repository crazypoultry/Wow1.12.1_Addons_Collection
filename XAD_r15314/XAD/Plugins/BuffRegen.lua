...
local Plugin = core:NewModule("potionbuffregen")
Plugin.fullname = "Regen Buff Items"
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("potionbuffregen")
...
function Plugin:ItemInList(itemlink)
	...
	return PT:ItemInSet(itemlink, "potionbuffregen")
end
