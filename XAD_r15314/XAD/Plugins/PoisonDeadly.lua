...
local Plugin = core:NewModule("poisondeadly", tempweaponbuffs)
Plugin.fullname = "Poison Deadly"

local PT = PeriodicTableEmbed:GetInstance("1")
-- register our custom item set w/ PT
PT:RegisterCustomSet("2892:1 2893:2 8984:3 8985:4","XADpoisondeadly")	
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("XADpoisondeadly")
...
function Plugin:ItemInList(itemlink, spellid)
	...
	return PT:ItemInSet(itemlink, "XADpoisondeadly")
end
