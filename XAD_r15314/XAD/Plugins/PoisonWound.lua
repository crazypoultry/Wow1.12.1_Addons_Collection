...
local Plugin = core:NewModule("poisonwound", tempweaponbuffs)
Plugin.fullname = "Poison Wound"

local PT = PeriodicTableEmbed:GetInstance("1")
-- register our custom item set w/ PT
PT:RegisterCustomSet("10918:1 10920:2 10921:3 10922:4","XADpoisonwound")	
...
function Plugin:ShowItem()
	local bag, slot = PT:GetBest("poisonwound")
...
function Plugin:ItemInList(itemlink, spellid)
	...
	return PT:ItemInSet(itemlink, "poisonwound")
end
