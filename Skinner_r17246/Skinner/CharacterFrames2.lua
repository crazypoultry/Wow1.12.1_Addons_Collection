...
-->>--	WhoFrame
	...
	self:skinEditBox(_G["WhoFrameEditBox"])
...
--	GuildControlPopupFrameCheckboxes
	...
	self:skinEditBox(_G["GuildControlPopupFrameEditBox"])
...
function Skinner:skinFFToggleTabs(tabName)
...
function Skinner:TradeFrame()
	...
	self:skinMoneyFrame(_G["TradePlayerInputMoneyFrame"])
