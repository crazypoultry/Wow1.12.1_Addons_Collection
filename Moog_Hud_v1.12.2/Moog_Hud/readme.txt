...
---------------------------------------------------------------------------
v1.12.2
  * Added buff / debuff chevron tooltip on/off function. When disabled, buffs / debuffs can be "clicked         through", allowing users to select targets through the icons. This is found in the /moog menu.

v1.12.1 - 17 September 2006
  * Added buff / debuff chevron on/off function to the menu (/moog to display)
  
v1.12.0 - 16 September 2006
* Updated TOC to the most recent patch.
* Added color-changing to player health bar for quick guaging of health status. (BETA user requested)
* Added self buff / debuffs to the left / right of the health/mana bars (respectively) for ease of viewing
* Modified pet bar colors due to "invisibility" effect in most terrains. (BETA user requested) 
