...
L:RegisterTranslations("koKR", function() return {
	["Conjured Crystal Water"] = "창조된 결정수",
	["Conjured Sparkling Water"] = "창조된 탄산수",
	["Conjured Mineral Water"] = "창조된 광천수",
	["Conjured Spring Water"] = "창조된 용천수",
	["Conjured Sweet Roll"] = "창조된 롤빵",
	["Conjured Sourdough"] = "창조된 효모빵",
	["Conjured Pumpernickel"] = "창조된 호밀빵",
    ...
    ["Trade"] = "아이템 거래",
    ["Accept conjured items in trade window automatically"] = "거래 창에 직업 용품 및 마법사의 음식, 음료 아이템이 올라오면 자동으로 수락합니다.",
    ["Oops. I don't have the space in my inventory for this."] = "현재 당신의 가방에 아이템을 받을 충분한 공간이 부족합니다. 확인하세요.",    
} end )
