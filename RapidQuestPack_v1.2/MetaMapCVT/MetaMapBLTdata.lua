...
MetaMapBLTDefaultData = {
    ...
    ZGMage = {
        { 0,"Spell_Frost_IceStorm","=q6="..ATLASLOOT_ZG_MAGE,"" },
    ...
    ZGWarlock = {
        { 0,"Spell_Shadow_CurseOfTounges","=q6="..ATLASLOOT_ZG_WARLOCK,"" },
    ...
    ZGPriest = {
        { 0,"Spell_Holy_PowerWordShield","=q6="..ATLASLOOT_ZG_PRIEST,"" },
    ...
    ZGRogue = {
        { 0,"Ability_BackStab","=q6="..ATLASLOOT_ZG_ROGUE,"" },
    ...
    ZGDruid = {
        { 0,"Spell_Nature_Regeneration","=q6="..ATLASLOOT_ZG_DRUID,"" },
    ...
    ZGHunter = {
        { 0,"Ability_Hunter_RunningShot","=q6="..ATLASLOOT_ZG_HUNTER,"" },
    ...
    ZGShaman = {
        { 0,"Spell_FireResistanceTotem_01","=q6="..ATLASLOOT_ZG_SHAMAN,"" },
    ...
    ZGWarrior = {
        { 0,"INV_Shield_05","=q6="..ATLASLOOT_ZG_WARRIOR,"" },
    ...
    ZGPaladin = {
        { 0,"Spell_Holy_SealOfMight","=q6="..ATLASLOOT_ZG_PALADIN,"" },
    ...
    AQ20Mage = {
        { 0,"Spell_Frost_IceStorm","=q6="..ATLASLOOT_AQ20_MAGE,"" },
    ...
    AQ20Warlock = {
        { 0,"Spell_Shadow_CurseOfTounges","=q6="..ATLASLOOT_AQ20_WARLOCK,"" },
    ...
    AQ20Priest = {
        { 0,"Spell_Holy_PowerWordShield","=q6="..ATLASLOOT_AQ20_PRIEST,"" },
    ...
    AQ20Rogue = {
        { 0,"Ability_BackStab","=q6="..ATLASLOOT_AQ20_ROGUE,"" },
    ...
    AQ20Druid = {
        { 0,"Spell_Nature_Regeneration","=q6="..ATLASLOOT_AQ20_DRUID,"" },
    ...
    AQ20Hunter = {
        { 0,"Ability_Hunter_RunningShot","=q6="..ATLASLOOT_AQ20_HUNTER,"" },
    ...
    AQ20Paladin = {
        { 0,"Spell_Holy_SealOfMight","=q6="..ATLASLOOT_AQ20_PALADIN,"" },
    ...
    AQ20Shaman = {
        { 0,"Spell_FireResistanceTotem_01","=q6="..ATLASLOOT_AQ20_SHAMAN,"" },
    ...
    AQ20Warrior = {
        { 0,"INV_Shield_05","=q6="..ATLASLOOT_AQ20_WARRIOR,"" },
    ...
    AQ40Skeram = {
        ...
        { 0,"","","" },
        { 21237, "INV_Staff_20", "=q4=Imperial Qiraji Regalia", "=ds=#m3#              	", "3.51%" },
        ...
        { 0,"","","" },
        { 21232, "INV_Staff_24", "=q4=Imperial Qiraji Armaments", "=ds=#m3#            ", "2.69%" },
    ...
    AQ40Viscidus = {
        ...
        { 0,"","","" },
        { 20932, "INV_Qiraj_BindingsDominance", "=q4=Qiraji Bindings of Dominance", "=q1=#m3#, #m1# =ds=#c8#, #c3#, #c7#, #c1#, #c4#", "87.32%  " },
        { 20928, "INV_Qiraj_BindingsCommand", "=q4=Qiraji Bindings of Command", "=q1=#m3#, #m1# =ds=#c5#, #c6#, #c9#, #c2#", "79.51%" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
    ...
    AQ40Huhuran = {
        ...
        { 0,"","","" },
        { 20932, "INV_Qiraj_BindingsDominance", "=q4=Qiraji Bindings of Dominance", "=q1=#m3#, #m1# =ds=#c8#, #c3#, #c7#, #c1#, #c4#", "76.81%" },
        { 20928, "INV_Qiraj_BindingsCommand", "=q4=Qiraji Bindings of Command", "=q1=#m3#, #m1# =ds=#c5#, #c6#, #c9#, #c2#", "72.32%" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
    ...
    AQ40Emperors = {
        ...
        { 0,"","","" },
        { 20930, "INV_Bracer_18", "=q4=Vek'lor's Diadem", "=q1=#m3#, #m1# =ds=#c7#, #c1#, #c6#, #c2#, #c4#", "85.63%	" },
        { 20926, "INV_Bracer_18", "=q4=Vek'nilash's Circlet", "=q1=#m3#, #m1# =ds=#c8#, #c3#, #c5#, #c9#", "84.33%" },
        { 0,"","","" },
        { 21237, "INV_Staff_20", "=q4=Imperial Qiraji Regalia", "=ds=#m3#              	", "3.51%" },
        { 21273, "INV_Staff_20", "=q4=Blessed Qiraji Acolyte Staff", "=q1=#m4#, =ds=#w9#" },
        { 21275, "INV_Staff_20", "=q4=Blessed Qiraji Augur Staff", "=q1=#m4#, =ds=#w9#" },
    ...
    AQ40Ouro = {
        ...
        { 23570, "INV_Misc_EngGizmos_19", "=q4=Jom Gabbar", "=ds=#s14#" },
        { 23558, "INV_Shield_23","=q4=The Burrower's Shell", "=ds=#s14#" },
        { 23557, "INV_Weapon_Rifle_10", "=q4=Larvae of the Great Worm", "=ds=#w5#" },
        { 0,"","","" },
        { 20927, "INV_Qiraj_OuroHide", "=q4=Ouro's Intact Hide", "=q1=#m3#, #m1# =ds=#c3#, #c5#, #c6#, #c9#", "78.93%" },
        { 20931, "INV_Qiraj_SkinSandworm", "=q4=Skin of the Great Sandworm", "=q1=#m3#, #m1# =ds=#c8#, #c7#, #c1#, #c2#, #c4#", "85.15%" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
    ...
    AQ40CThun = {
        ...
        { 0,"","","" },
        { 20933, "INV_Qiraj_HuskOldGod", "=q4=Husk of the Old God", "=q1=#m3#, #m1# =ds=#c8#, #c3#, #c1#, #c5#", "81.93%" },
        { 20929, "INV_Qiraj_CarapaceOldGod", "=q4=Carapace of the Old God", "=q1=#m3#, #m1# =ds=#c7#, #c6#, #c9#, #c2#, #c4#", "77.88%" },
        { 0,"","","" },
    ...
    AQ40Mage = {
        { 0,"Spell_Frost_IceStorm","=q6="..ATLASLOOT_AQ40_MAGE,"" }, --Mage
    ...
    AQ40Priest = {
        { 0,"Spell_Holy_PowerWordShield","=q6="..ATLASLOOT_AQ40_PRIEST,"" }, --Priest
    ...
    AQ40Warlock = {
        { 0,"Spell_Shadow_CurseOfTounges","=q6="..ATLASLOOT_AQ40_WARLOCK,"" }, --Warlock
    ...
    AQ40Rogue = {
        { 0,"Ability_BackStab","=q6="..ATLASLOOT_AQ40_ROGUE,"" }, --Rogue
    ...
    AQ40Druid = {
        { 0,"Spell_Nature_Regeneration","=q6="..ATLASLOOT_AQ40_DRUID,"" }, --Druid
    ...
    AQ40Shaman = {
        { 0,"Spell_FireResistanceTotem_01","=q6="..ATLASLOOT_AQ40_SHAMAN,"" }, --Shaman
    ...
    AQ40Hunter = {
        { 0,"Ability_Hunter_RunningShot","=q6="..ATLASLOOT_AQ40_HUNTER,"" }, --Hunter
    ...
    AQ40Warrior = {
        { 0,"INV_Shield_05","=q6="..ATLASLOOT_AQ40_WARRIOR,"" }, --Warrior
    ...
    AQ40Paladin = {
        { 0,"Spell_Holy_SealOfMight","=q6="..ATLASLOOT_AQ40_PALADIN,"" }, --Paladin
   ...
   WCDeviateFaerieDragon = {
    ...
    BRDPanzor = {
        { 22245, "INV_Boots_Cloth_05", "=q3=Soot Encrusted Footwear", "=ds=#s12#s,#a1#", "22.06%" },
  ...
  -------------------------------------
    ...
    DMEZevrimThornhoof = {
        ...
        { 0, "", "", "" },
        { 18308, "INV_Helmet_51", "=q2=Clever Hat",                "=ds=#s1#, #a1#", "23.73%" },
    ...
    DTaerar = {
        { 20631, "INV_Boots_Cloth_05", "=q4=Mendicant's Slippers",     "=ds=#s12#s, #a1#", "13.14%" },
        { 20634, "INV_Boots_08", "=q4=Boots of Fright",                "=ds=#s12#s, #a2#", "10.15%" },
        ...
        { 20619, "INV_Boots_Plate_04", "=q4=Acid Inscribed Greaves",   "=ds=#s12#s, #a4# =q1=#m5#", "8.85%" },
    ...
    DEmeriss = {
        ...
        { 20621, "INV_Boots_Chain_11", "=q4=Boots of the Endless Moor",      "=ds=#s12#s, #a3#", "10.24%" },
    ...
    DLethon = {
        ...
        { 20629, "INV_Boots_Chain_08", "=q4=Malignant Footguards",         "=ds=#s12#s, #a3#", "4.46%" },
    ...
    DYsondre = {
        { 20635, "INV_Chest_Cloth_39", "=q4=Jade Inlaid Vestments",        "=ds=Robe, #a1#", "14.19%" },
    ...
    AAzuregos = {
        ...
        { 19131, "INV_Boots_Cloth_14", "=q4=Snowblind Shoes",             "=ds=#s12#s, #a1#", "12.23%" },
    ...
    NAXPatchwerk = {
        { 22726, "INV_Qiraj_JewelBlessed", "=q5=Splinter of Atiesh", "=ds=#m2#" },
        { 0, "", "", "" },
        ...
        { 0, "", "", "" },
        { 22960, "INV_Misc_Cape_Naxxramas_02", "=q4=Cloak of Suturing", "=ds=#s4#" },
        { 22815, "INV_Axe_22", "=q4=Severance", "=ds=#h2#, #w1#" },
        { 22820, "INV_Wand_1H_Stratholme_D_01", "=q4=Wand of Fates", "=ds=#w12#" },
        { 22818, "INV_Shield_27", "=q4=The Plague Bearer", "=ds=#w8#" },
        { 22961, "INV_Jewelry_Ring_49Naxxramas", "=q4=Band of Reanimation", "=ds=Ring" },
        };
    ...
    NAXThaddius = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Chest of Thaddius", "=ds=#s14#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Mace of Thaddius", "=ds=#s14#" },
        { 23001, "INV_Trinket_Naxxramas02", "=q4=Eye of Diminution", "=ds=#s14#" },
        };

    NAXAnubRekhan = {
        { 22726, "INV_Qiraj_JewelBlessed", "=q5=Splinter of Atiesh", "=ds=#m2#", "27.61%" },
        { 0, "", "", "" },
    ...
    NAXGrandWidowFaerlina = {
        ...
        { 0, "", "", "" },
        { 22941, "INV_Shoulder_07", "=q4=Polar Shoulder Pads", "=ds=#s3#, #a2#" },
        { 22940, "INV_Shoulder_16", "=q4=Icebane Pauldrons", "=ds=#s3#, #a4#" },
        { 22806, "INV_Sword_60", "=q4=Widow's Remorse", "=ds=#h1# #w10#" },
        { 22942, "INV_Mace_29", "=q4=The Widow's Embrace", "=ds=#h1# #w6#" },
        { 22943, "INV_Jewelry_Necklace_29Naxxramas", "=q4=Malice Stone Pendant", "=ds=#s2#" },
        };

    NAXMaexxna = {
        { 22726, "INV_Qiraj_JewelBlessed", "=q5=Splinter of Atiesh", "=ds=#m2#" },
        { 0, "", "", "" },
        { 22371, "INV_Misc_Desecrated_ClothGlove", "=q4=Desecrated Gloves", "=q1=#m1# =ds=#c8#, #c3#, #c5#" },
        { 22364, "INV_Misc_Desecrated_MailGlove", "=q4=Desecrated Handguards", "=q1=#m1# =ds=#c4#, #c7#, #c2#, #c1#" },
        { 22357, "INV_Misc_Desecrated_PlateGloves", "=q4=Desecrated Gauntlets", "=q1=#m1# =ds=#c9#, #c6#" },
        { 0, "", "", "" },
        { 23220, "INV_Chest_Cloth_46", "=q4=Crystal Webbed Robe", "=ds=#s5#, #a1#" },
        { 22804, "INV_knife_1h_stratholme_d_01", "=q4=Maexxna's Fang", "=ds=#w4#" },
        { 22807, "INV_Sword_11", "=q4=Wraith Blade", "=ds=#h1# #w10#" },
        { 22947, "INV_Jewelry_Necklace_28Naxxramas", "=q4=Pendant of Forgotten Names", "=ds=#s2#" },
        { 22954, "INV_Trinket_Naxxramas04", "=q4=Kiss of the Spider", "=ds=#s14#" },
        };

    NAXInstructorRazuvious = {
        { 22726, "INV_Qiraj_JewelBlessed", "=q5=Splinter of Atiesh", "=ds=#m2#", "24.39%" },
        { 0, "", "", "" },
    ...
    NAXGothikderHarvester = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Boots of Displacement", "=ds=#s12#, #a2#" },
    ...
    NAXTheFourHorsemen = {
        ...
        { 0, "", "", "" },
        { 0, "INV_Misc_QuestionMark", "=q4=Leggings of the Apocalypse", "=ds=#s11#, #a2#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Maul of the Redeemed Crusader", "=ds=#h2# #w6#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Bow of the Four Horsemen", "=ds=#w2#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Seal of the Damned", "=ds=#s13#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Sadist's Collar", "=ds=#s2#" },
        { 0, "", "", "" },
        { 0, "INV_Misc_QuestionMark", "=q4=Corrupted Ashbringer", "=ds=#h2# #w10# =q2=Mograine" },
        };
    ...
    NAXNothderPlaguebringer = {
        ...
        { 0, "", "", "" },
        { 23030, "INV_Misc_Cape_Naxxramas_01", "=q4=Cloak of the Scourge", "=ds=#s4#" },
        { 22816, "INV_Axe_08", "=q4=Hatchet of Sundered Bone", "=ds=#h1# #w1#" },
        { 23005, "INV_Relics_TotemofLife", "=q4=Totem of Flowing Water", "=ds=#s16#, #e17#" },
        { 23006, "INV_Relics_LibramofGrace", "=q4=Libram of Light", "=ds=#s16#, #e18#" },
        { 23029, "INV_Offhand_Naxxramas_04", "=q4=Noth's Frigid Heart", "=ds=#s15#" },
        { 23031, "INV_Jewelry_Ring_53Naxxramas", "=q4=Band of the Inevitable", "=ds=#s13#" },
        { 23028, "INV_Jewelry_Ring_35", "=q4=Hailstone Band", "=ds=#s13#" },
        };
    ...
    NAXLoatheb = {
        ...
        { 0, "", "", "" },
        { 0, "INV_Misc_QuestionMark", "=q4=The Eye of Nerub", "=ds=#w7#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Brimstone Staff", "=ds=Staff" },
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of Spiritual Fervor", "=ds=#s13#" },
        { 23038, "INV_Jewelry_Ring_48Naxxramas", "=q4=Band of Unnatural Forces", "=ds=#s13#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Loatheb's Reflection", "=ds=#s14#" },
        };

    NAXSapphiron = {
        { 0, "INV_Misc_QuestionMark", "=q4=Cloak of the Necropolis", "=ds=#s4#" },
        { 0, "INV_Misc_QuestionMark", "=q4=The Face of Death", "=ds=#w8#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Claw of the Frost Wyrm", "=ds=#w8#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Sapphiron's Left Eye", "=ds=#s15#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Sapphiron's Right Eye", "=ds=#s15#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Glyph of Deflection", "=ds=#s14#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Eye of the Dead", "=ds=#s14#" },
        { 0, "INV_Misc_QuestionMark", "=q4=The Restrained Essence of Sapphiron", "=ds=#s14#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Slayer's Crest", "=ds=#s14#" },
        { 0, "", "", "" },
        { 0, "INV_Misc_QuestionMark", "=q4=Power of the Scourge", "=ds=#s3# #e11#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Resilience of the Scourge", "=ds=#s3# #e11#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Fortitude of the Scourge", "=ds=#s3# #e11#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Might of the Scourge", "=ds=#s3# #e11#" },
        };

    NAXKelThuzard = {
        { 0, "INV_Misc_QuestionMark", "=q4=Fists of the Unrelenting", "=ds=#s9#, #a4#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Kingsfall", "=ds=#w4#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Gressil, Dawn of Ruin", "=ds=#h1# #w10#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Hammer of the Twisting Nether", "=ds=#h1# #w6#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Might of Menethil", "=ds=#h2# #w6#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Doomfinger", "=ds=#w12#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Nerubian Slavemaker", "=ds=#w3#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Shield of Condemnation", "=ds=#w8#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Gem of Trapped Innocents", "=ds=#s2#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Necklace of Kel'thuzad", "=ds=#s2#" },
        { 0, "", "", "" },
        { 0, "", "", "" },
        { 0, "", "", "" },
        { 0, "", "", "" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Cryptstalker", "=ds=#s13# =q1=#m1# =ds=#c2#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Frostfire Ring", "=ds=#s13# =q1=#m1# =ds=#c3#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of Redemption", "=ds=#s13# =q1=#m1# =ds=#c4#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of Faith", "=ds=#s13# =q1=#m1# =ds=#c5#" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Plagueheart Ring", "=ds=#s13# =q1=#m1# =ds=#c8#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Dreadnaught", "=ds=#s13# =q1=#m1# =ds=#c9#" },
        };

    NAXTrash = {
        { 0, "INV_Misc_QuestionMark", "=q4=Shroud of Dominion", "=ds=#s4#" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Life Channeling Necklace", "=ds=#s2#" },
        { 0, "INV_Misc_QuestionMark", "=q4=Warmth of Forgiveness", "=ds=#s14#" },
    ...
    T3Mage = {
        { 0,"Spell_Frost_IceStorm","=q6="..ATLASLOOT_T3_MAGE,"" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Frostfire Ring", "" },
        };
    T3Warlock = {
        { 0,"Spell_Shadow_CurseOfTounges","=q6="..ATLASLOOT_T3_WARLOCK,"" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Plagueheart Ring", "" },
        };
    T3Priest = {
        { 0,"Spell_Holy_PowerWordShield","=q6="..ATLASLOOT_T3_PRIEST,"" },
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of Faith", "" },
        };
    T3Rogue = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Bonescythe Ring", "" },
        };
    T3Druid = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Dreamwalker", "" },
        };
    T3Hunter = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Cryptstalker", "" },
        };
    T3Paladin = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of Redemption", "" },
        };
    T3Shaman = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Earthshatterer", "" },
        };
    T3Warrior = {
        ...
        { 0, "INV_Misc_QuestionMark", "=q4=Ring of the Dreadnaught", "" },
        };    
    ...
    AVExalted = {
        ...
        { 0, "", "", "" },
        { 0, "INV_BannerPVP_01", "=q6=#m6#", "=q5=#b2#" },
        { 19030, "INV_Misc_Horn_01", "=q4=Horn of the Frostwolf Howler", "=ds=#e7#" },
        { 19312, "INV_Misc_Flower_04", "=q4=Lei of the Lifegiver", "=ds=#s15#" },
        { 19315, "INV_Misc_Branch_01", "=q4=Therazane's Touch", "=ds=#s15#" },
        { 19308, "INV_Misc_Book_01", "=q4=Tome of Arcane Domination", "=ds=#s15#" },
        { 19311, "INV_Misc_Book_09", "=q4=Tome of Fiery Arcana", "=ds=#s15#" },
