...
function oSkin:GuildRegistrar()
	...
	editBox:SetHeight(editBox:GetHeight() * FyMult)
	self:removeRegions(editBox, {6, 7}) -- N.B. other regions are scripts etc
	local left, right, top, bottom = editBox:GetTextInsets()
	editBox:SetTextInsets(left + 5, right + 5, top, bottom)
