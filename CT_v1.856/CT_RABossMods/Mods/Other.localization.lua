...
if ( GetLocale() == "deDE" ) then
	...
	CT_RABOSS_ONYXIA_PHASE2TEXT		        = "*** ONYXIA TRITT PHASE 2 EIN ***"
    CT_RABOSS_ONYXIA_PHASE3TEXT		        = "*** ONYXIA TRITT PHASE 3 EIN ***"
    CT_RABOSS_ONYXIA_PHASE2INFO1	        = "Phase 2 Warnung";
    CT_RABOSS_ONYXIA_PHASE3INFO1	        = "Phase 3 Warnung";
    CT_RABOSS_ONYXIA_PHASE2INFO2	        = "Warns for when Onyxia takes flight to enter phase 2 of the encounter.";
    CT_RABOSS_ONYXIA_PHASE3INFO2	        = "Warns for when Onyxia lands to enter phase 3 of the encounter.";
    
    CT_RABOSS_ONYXIA_BREATH 		        = "atmet tief ein";
    CT_RABOSS_ONYXIA_PHASE2			        = "Diese sinnlose Anstrengung langweilt mich. Ich werde Euch alle von oben verbrennen!";
    CT_RABOSS_ONYXIA_PHASE3			        = "Mir scheint, dass Ihr noch eine Lektion braucht, sterbliche Wesen!";
end