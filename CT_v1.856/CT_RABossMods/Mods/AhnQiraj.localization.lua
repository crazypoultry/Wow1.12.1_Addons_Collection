...
CT_RABOSS_TWINEMPERORS_TELEPORTINC = "*** %d SEC TO TELEPORT ***";

-- Viscidus
CT_RABOSS_VISCIDUS_INFO = "Alerts for his frozen state and when people are in poison clouds.";
CT_RABOSS_VISCIDUS_CLOUD = "Send Tells on Clouds";
CT_RABOSS_VISCIDUS_CLOUD_INFO = "Send a tell to players who are standing inside a poison cloud.";
CT_RABOSS_VISCIDUS_TOXINREGEXP = "^([^%s]+) ([^%s]+) afflicted by Toxin.$";
...
-- C'Thun
CT_RABOSS_CTHUN_INFO = "Alerts for Eye Tentacle spawns and his weakened state in phase 2."
...
CT_RABOSS_CTHUN_INVULN = ">> INVULNERABLE <<";
CT_RABOSS_CTHUN_TENT5 = "*** [EYES IN 5 SEC] ***";
CT_RABOSS_CTHUN_TENT45 = "*** C'THUN ENGAGED - 45 SEC TO EYES ***";
CT_RABOSS_CTHUN_TENTSPAWN = "*** [EYES SPAWNED] - 45 SEC TO NEXT ***";
CT_RABOSS_CTHUN_GLAREINC = "!!! DARK GLARE IN 5s !!!";
CT_RABOSS_CTHUN_GLARE = "!!! DARK GLARE - MOVE !!!";
CT_RABOSS_CTHUN_GLARESTOPINC = "!!! DARK GLARE END IN 5s !!!";
CT_RABOSS_CTHUN_GLARESTOP = "!!! Dark Glare end - 47s to next !!!";
...
CT_RABOSS_RAJAXX_TUUBID = "Captain Tuubid";
	-- Waves
...
CT_RABOSS_RAJAXX_TUUBID_REGEXP = "^Kill ([^%s]+)!$";

CT_RABOSS_RAJAXX_YOURSELF = "YOURSELF";
CT_RABOSS_RAJAXX_HEALTARGET = "*** HEAL %s ***";
