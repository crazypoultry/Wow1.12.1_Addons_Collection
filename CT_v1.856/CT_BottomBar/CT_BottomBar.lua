...
function CT_BottomBar_Enable()
	...
	--MainMenuBarPerformanceBarFrame:SetWidth(20);
	MainMenuBarPerformanceBarFrame:SetPoint("BOTTOMRIGHT", "CT_BottomBarFrameLatency", "BOTTOMRIGHT", -3, 3);
	MainMenuBarPerformanceBar:ClearAllPoints();
	MainMenuBarPerformanceBar:SetPoint("TOPRIGHT", "CT_BottomBarFrameLatency", "TOPRIGHT", -2, 11);
	MainMenuBarPerformanceBarFrameButton:ClearAllPoints();
	MainMenuBarPerformanceBarFrameButton:SetAllPoints(MainMenuBarPerformanceBarFrame);
	MainMenuBarPerformanceBarFrameButton:SetFrameStrata("HIGH");
	...
	ReputationWatchBar:SetPoint("TOPLEFT", "CT_BottomBarFrameXP", "TOPLEFT", 0, -1);
...
function CT_BottomBar_Disable()
	...
	-- Latency
	MainMenuBarPerformanceBarFrame:ClearAllPoints();
	MainMenuBarPerformanceBarFrame:SetPoint("BOTTOMRIGHT", "MainMenuBar", "BOTTOMRIGHT", ( ( SHOW_KEYRING == 1 and -235 ) or -227 ), -10);
...
function CT_BottomBar_CheckKeyRing()
	if ( CT_BottomBar_Enabled[UnitName("player")] and CT_BottomBar_RotatedFrames[UnitName("player")] and CT_BottomBar_RotatedFrames[UnitName("player")]["Bags"] ) then
		KeyRingButton:ClearAllPoints();
		KeyRingButton:SetPoint("BOTTOM", "MainMenuBarBackpackButton", "TOP", 0, 2);
		KeyRingButton:SetWidth(39);
		KeyRingButton:SetHeight(18);
		KeyRingButton:SetNormalTexture("Interface\\AddOns\\CT_BottomBar\\Images\\KeyRingRotated");
		KeyRingButton:SetPushedTexture("Interface\\AddOns\\CT_BottomBar\\Images\\KeyRingRotated_Down");
		KeyRingButton:SetHighlightTexture("Interface\\AddOns\\CT_BottomBar\\Images\\KeyRingRotated_Highlight");
		
		KeyRingButton:GetNormalTexture():SetTexCoord(0, 37/64, 0, 16/32);
		KeyRingButton:GetPushedTexture():SetTexCoord(0, 37/64, 0, 16/32);
		KeyRingButton:GetHighlightTexture():SetTexCoord(0, 37/64, 0, 16/32);
		
		MainMenuBarBackpackButton:SetPoint("TOPLEFT", "CT_BottomBarFrameBags", "TOPLEFT", 7, -20);
	else
		KeyRingButton:ClearAllPoints();
		KeyRingButton:SetPoint("RIGHT", "CharacterBag3Slot", "LEFT", -5, 0);
		KeyRingButton:SetWidth(18);
		KeyRingButton:SetHeight(39);
		...
		KeyRingButton:GetNormalTexture():SetTexCoord(0, 0.5625, 0, 0.609375);
		KeyRingButton:GetPushedTexture():SetTexCoord(0, 0.5625, 0, 0.609375);
		KeyRingButton:GetHighlightTexture():SetTexCoord(0, 0.5625, 0, 0.609375);
	end
end
...
function CT_BottomBar_newReputationWatchBar_Update(newLevel)
	if ( CT_BottomBar_Enabled[UnitName("player")] and CT_BottomBar_HiddenFrames[UnitName("player")]["XP"] ) then
