if ( GetLocale() == "deDE" ) then
	...
	CT_RA_MINDVISION = "Gedankensicht";
	CT_RA_DREAMLESSSLEEP = "Traumloser Schlaf";
	...
	-- "Regexps"
	CT_RA_HASJOINEDRAIDREGEXP = "^([^%s]+) hat sich der \195\131\197\147berfallgruppe angeschlossen%.$";
	CT_RA_HASLEFTRAIDREGEXP = "^([^%s]+) hat die \195\131\197\147berfallgruppe verlassen%.$";
	CT_RA_TANKHASDIEDREGEXP = "^([^%s]+) stirbt%.$";
end
