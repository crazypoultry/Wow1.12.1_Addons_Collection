...
-- onUpdate
onUpdate = function()
	if this.joinWaitingChannelsTimeOut then
		this.joinWaitingChannelsTimeOut = this.joinWaitingChannelsTimeOut - arg1;
		if this.joinWaitingChannelsTimeOut <= 0 then
			this.joinWaitingChannelsTimeOut = nil;
			joinWaitingChannels();
		end
	end
end
...
function lib:LibActivate(stub, oldLib, oldList)
	...
	if GetChannelList()==1 then
		...
		self.Frame.joinWaitingChannelsTimeOut = 10;
	end
