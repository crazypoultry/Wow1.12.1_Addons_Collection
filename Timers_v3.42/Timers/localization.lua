...
TIMERS_LOC_SCRIPT = "Script";
TIMERS_LOC_CTRAID = "CT Raid";
TIMERS_LOC_OFFICER = "Officer";
TIMERS_LOC_GUILD = "Guild";
TIMERS_LOC_SCT = "SCT";
TIMERS_LOC_ONSCREEN = "OnScreen";
TIMERS_LOC_BOTH = "CT & Raid";
...
TIMERS_LOC_SPELL_CAST = "Spell/Skill:";
TIMERS_LOC_ADD_TIMER = "add new timer";
TIMERS_LOC_ADD = "Add";
TIMERS_LOC_NEW_TIMER = "New Timer";
TIMERS_LOC_AUCTION_MIN = "Auction min.";
TIMERS_LOC_AUCTION_MAX = "Auction max.";
TIMERS_LOC_NOT_AUCTION = "It's not allowed to change the auctiontrigger text.";
TIMERS_LOC_OVERBID = " overbid";
TIMERS_LOC_UNKNOWN = " unkown";
TIMERS_LOC_USE_BARS = " show Timerbars";
...
TIMERS_LOC_AUCTION = "Auction";
TIMERS_LOC_BWL = "Blackwing Lair";
...
TIMERS_LOC_HELP_CAT3 = TIMERS_LOC_HELP_CAT3.."      3.4.9.9 Reset\n";
TIMERS_LOC_HELP_CAT3 = TIMERS_LOC_HELP_CAT3.."When a timer of this trigger is running, it\n";
TIMERS_LOC_HELP_CAT3 = TIMERS_LOC_HELP_CAT3.."will be resetted, no new timer will be started.\n\n";
...
TIMERS_LOC_HELP_CAT5 = TIMERS_LOC_HELP_CAT5.."- \"add name time [channel] [msg]\n";
TIMERS_LOC_HELP_CAT5 = TIMERS_LOC_HELP_CAT5.."	[warnchan] [warnmsg] [warntime]\"\n"; 			
TIMERS_LOC_HELP_CAT5 = TIMERS_LOC_HELP_CAT5.."  This will add a new timer\n";
TIMERS_LOC_HELP_CAT5 = TIMERS_LOC_HELP_CAT5.."- \"addi name [time]\n";
TIMERS_LOC_HELP_CAT5 = TIMERS_LOC_HELP_CAT5.."  This will add a new incremental timer\n";	
...
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."6.7 I want to make a new spellcast or skill\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."trigger, but i don't know the message, i've to\n";
...
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."6.8 How can i change the default channels,\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."messages and values?\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."- Change the no group->default trigger.\n\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."6.9 How can i use the channel \"script\"?\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."- With the channel script, you can run lua\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."scripts. It works the same way as \"/script\".\n\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."6.10 Can i start a timer by another timer ?\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."- Yes, you can with the \"script\" channel.\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."A.E. set the message to: \n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."\"Timers_Invoke(\"Name\")\".\n";
TIMERS_LOC_HELP_CAT6 = TIMERS_LOC_HELP_CAT6.."That will trigger the trigger \"Name\".\n\n";
...
TIMERS_LOC_CTRAID = "CT Raid";
TIMERS_LOC_BOTH = "CT & Schlacht."
TIMERS_LOC_OFFICER = "Offiziere";
TIMERS_LOC_GUILD = "Gilde";
TIMERS_LOC_SCT = "SCT";
TIMERS_LOC_SCRIPT = "Script";
TIMERS_LOC_ONSCREEN = "OnScreen";
TIMERS_LOC_DEFAULT = "Standard";
...
TIMERS_LOC_NOT_TEXT = "Der Standardausl\195\182ser und darf keinen Text haben";
...
TIMERS_LOC_RESETALLTRIGGER = "Standard Ausl\195\182ser neu laden.";
TIMERS_LOC_RESETTRIGGER = "Standard wiederherstellen";
...
TIMERS_LOC_SPELL_CAST = "Zauber/Aktion:";
TIMERS_LOC_ADD_TIMER = "neuen Timer hinzuf\195\188gen";
TIMERS_LOC_ADD = "Speichern";
TIMERS_LOC_NEW_TIMER = "Neuer Timer";
TIMERS_LOC_AUCTION_MIN = "Auktion min.";
TIMERS_LOC_AUCTION_MAX = "Auktion max.";
TIMERS_LOC_NOT_AUCTION = "Der Text der Auktionsausl\195\182ser darf nicht modifiziert werden.";
TIMERS_LOC_OVERBID = "\195\188berboten";
TIMERS_LOC_UNKNOWN = "unbekannt";
TIMERS_LOC_USE_BARS = " zeige Timerbalken";
...
TIMERS_LOC_AUCTION = "Auktionen";
TIMERS_LOC_BWL = "Pechschwingen Hort";
end