...
SlashCommands:
  ...
  /iom -- brings op the GUI

  Other Usage: /iom option
    Options:
	enable -- Enables InviteOMatic
	disable -- Disables InviteOMatic
...
Changelog:
v2.05 --> v2.06
Added possibility for multiple magic words, separate the words with space.
IE: invite inv   -- Would trigger for both invite and inv

v2.04 --> v2.05
Tried to fix the bug that kicks people out of raid and then reinvites them.
Readded the slashcommands, resetaiglist, resetdeclinelist, resetignorelist,
for use in macroes.

v2.03 --> v2.04
Fixed a small bug regarding whisper invite, if it was off when you loaded the addon.
Added a slashcommand to toggle debug: /iom debug

v2.02 --> v2.03
Removed debug flag, sorry guys :/

v2.01 --> v2.02
Added german translation

v2.00 --> v2.01
Fixed a bug where languages that dosent have a translation got errors.

v1.16 --> v2.00
Complete rewrite of the codebase, and a brand new GUI!!
No more Khaos dependencie.
Small Panel with buttons for quick access of features.
New remove all players that are not promoted, feature.
New Panic! button.
Removed most slash commands, as there are now buttons on the GUI panel :)
