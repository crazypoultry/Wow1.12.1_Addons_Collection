...
LOOTLINK_CHATSEARCH = "search";
LOOTLINK_CHATSEARCH2 = "s";
...
LOOTLINK_STATICPOPUP_ITEM_CONFIRM = "%s %s  Are you sure you want to do this?";
	...
	LOOTLINK_STATICPOPUP_LINKITEM = "Attempting to |cff00ff00link|r this item could cause a disconnect.";
	LOOTLINK_STATICPOPUP_DRESSUP = "Attempting to |cffbbbb66dress up|r with this item could cause a disconnect.";
