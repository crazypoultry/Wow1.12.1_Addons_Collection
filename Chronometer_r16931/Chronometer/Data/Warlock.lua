...
function Chronometer:WarlockSetup()
	...
	self:AddTimer(self.SPELL, BS["Shadow Bolt"],             0, 1,0,0, { ea={[L["Shadow Vulnerability"]]=2} })
	...
	self:AddTimer(self.EVENT, L["Shadow Vulnerability"],   12, 1,0,0, { cr="GREEN", xn=BS["Shadow Bolt"] })
	self:AddTimer(self.EVENT, BS["Shadow Trance"],          10, 0,1,1, { cr="GREEN", a=1, xn=BS["Nightfall"] })
	self:AddTimer(self.EVENT, L["Soul Siphon"],            10, 0,1,1, { cr="GREEN", a=1, xn=BS["Drain Soul"] })
end
