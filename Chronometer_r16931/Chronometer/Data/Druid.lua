...
function Chronometer:DruidSetup()
	...
	self:AddTimer(self.SPELL, L["Faerie Fire (Feral)"],     40, 1,0,0, { gr=2, rc=true })
	...
	self:AddTimer(self.SPELL, BS["Regrowth"],              21, 1,1,1, { rc=true, mc=L["Swiftmend"] })
	self:AddTimer(self.SPELL, BS["Rejuvenation"],          12, 1,1,1, { rc=true, mc=L["Swiftmend"] })
	self:AddTimer(self.SPELL, BS["Rip"],                   12, 1,0,0, { rc=true })
	self:AddTimer(self.SPELL, BS["Soothe Animal"],         15, 1,0,0, { rc=true })
	self:AddTimer(self.SPELL, BS["Starfire"],               0, 1,0,0, { ea={[L["Starfire Stun"]]=1} })
	...
	self:AddTimer(self.EVENT, L["Starfire Stun"],          3, 1,0,0, { xn=BS["Starfire"] })
end
