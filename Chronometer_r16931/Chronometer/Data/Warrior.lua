...
function Chronometer:WarriorSetup()
	...
	self:AddTimer(self.SPELL, BS["Charge"],               0, 1,0,0, { ea={[L["Charge Stun"]]=1} })
	...
	self:AddTimer(self.SPELL, BS["Intercept"],            0, 1,0,0, { ea={[L["Intercept Stun"]]=1} })
	...
	self:AddTimer(self.SPELL, BS["Shield Bash"],          6, 1,0,0, { ea={[L["Shield Bash - Silenced"]]=1} })
	...
	self:AddTimer(self.EVENT, L["Charge Stun"],          1, 1,0,0, { xn=BS["Charge"] })
	...
	self:AddTimer(self.EVENT, L["Intercept Stun"],       3, 1,0,0, { xn=BS["Intercept"] })
	...
	self:AddTimer(self.EVENT, L["Shield Bash - Silenced"], 3, 1,0,0, { cr="GREEN", xn=BS["Shield Bash"] })
