...
function Chronometer:PaladinSetup()
	...
	self:AddTimer(self.SPELL, BS["Blessing of Protection"],  6, 1,1,1, { gr=1, d={rs=2}, ea={[L["Forbearance"]]=1} })
	...
	self:AddTimer(self.SPELL, BS["Divine Protection"],       6, 0,1,1, { cr="BLUE", d={rs=2}, ea={[L["Forbearance"]]=1} })
	self:AddTimer(self.SPELL, BS["Divine Shield"],          10, 0,1,1, { cr="BLUE", d={rs=2}, ea={[L["Forbearance"]]=1} })
	...
	self:AddTimer(self.EVENT, L["Forbearance"],               60, 1,0,1, { tx="Interface\\Icons\\Spell_Holy_RemoveCurse" })
