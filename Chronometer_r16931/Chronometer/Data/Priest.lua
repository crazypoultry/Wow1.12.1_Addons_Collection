...
function Chronometer:PriestSetup()
	...
	self:AddTimer(self.SPELL, BS["Power Word: Shield"],  30, 1,1,1, { ea={[L["Weakened Soul"]]=1} })
	...
	self:AddTimer(self.EVENT, L["Shadow Vulnerability"], 15, 1,0,0, { a=1, xn=BS["Shadow Weaving"] })
	self:AddTimer(self.EVENT, BS["Spirit Tap"],           15, 0,1,1, { a=1 })
	self:AddTimer(self.EVENT, L["Weakened Soul"],        15, 1,0,1, { tx="Interface\\Icons\\Spell_Holy_AshesToAshes" })
