if( GetLocale() == "frFR" ) then
	...
	-- R10
	CTA_MONITOR_CHANNEL_NAME	 	= "RechercheGroupe";
	
	--R10 localized strings go here (Incomplete)
	
	
	--R11 localized strings go here (Missing)
	...
	--[[
		...
		R12B1, R12B2, R12B3, R12B4 by leonil (Milok)
		last update: 4th October, 2006
	--]]
	
	CTA_TRIGGER_LIST = {
	  ["LFM"] = { "lf ", "lf%d*m", "looking for more", "need %d* more", "r?e?cherchen?t?", "need ",
	     "r?e?cherchons", "recrute", "recrutement",
	     "recrutons", "manque", "manquons", "mank",
	     "monte", "monde", "personnes?", 
	     "besoin", "qui", "ki", "des gens", "places?", "venez", 
	     "reste", "int\195\169rr?ess\195\169s?", "interr?esses?","partons", "parti.?", "souhaite", 
	     "volontaires?", "formation", "forme", "formons", 
	     "full", "complet", "motiv.s?", "quelqu'?un", "motiver", "quelqu", "qqn", },
	  ["LFG"] = { "lfg", "cherche groupe", "cherche raid", "disponible", "dispo", "un groupe", "un raid", "grp", "cherche",},
	  ["CLASSES"] = {
	   ["DRUID"] = { "druids?", "druidesses?", "druides?",},
	   ["HUNTER"] = { "hunts?", "hunteu?rs?", "chasseurs?", "chasseuses?", },
	   ["MAGE"] = { "magos?", "magettes?", "mages?", },
	   ["PALADIN"] = { "paladine", "pals?", "paladins?", "paloufs?", "pala", },
	   ["PRIEST"] = { "pretr\195\170sses?", "pr\195\170tres?", "pretres?", "pretresses?", },
	   ["ROGUE"] = { "voleuses?", "fufus?", "rogues?", "voleurs?", },
	   ["SHAMAN"] = { "chams?", "chamans?", "chamys?", "chamis?", "chamines?", },
	   ["WARLOCK"] = { "demonistes?", "demos?", "d\195\169monistes?", "d\195\169mos?", },
	   ["WARRIOR"] = { "guerri\195\168res?", "guerrieres?","wars?", "warriors?", "guerriers?", "wawas?", },
	   ["HEALER"] = { "soigneuses?", "heals?", "healers?", "healeurs?", "soigneurs?", },
	   ["TANK"] = { "tanks?", "mts?", },
	   ["DAMAGE"] = { "damage", "dps", "dmg", },
	   ["RANDOM"] = { "compagnons?", "classes?", "types?", "dernier", },
	  },
	  ["SPAM"] = { "channel", "lol", "chuck", "norris", "lmao", "lmfao", "rofl",
	      "guilde", "wtf", "wtb", "stfu", "ignore", "enchant", "noob", "nab",
	      "nub", "n00b", "vin", "gl", "gg", "trogdoor", "ptdr", "mdr", "boulet",
	      "con", "kevin", "k12", "abrutie", "enchenteur", "spam", "bravo", "bravos",
	      "prouris", "pourris", "pourave", "dsl", "desole", "d\195\169sol\195\169", },
	  ["GOAL"] = {
	   ["AHNQUIRAJ"] = { "aq", "aq20", "aq40", "ahn", "quiraj", },
	   ["ALTERAC"] = { "alterac", "vall\195\169e?", "vallee?", },
	   ["ARATHI"] = { "arathi", "bassin", },
	   ["BLACKFATHOM"] = { "profondeurs?", "brassenoire?", "mtiefen? ", "bfd",},
	   ["BLACKROCKDEPTHS"] = { "blackrock", "brd", "imperator", "windsor", },
	   ["BLACKWING"] = { "bwl", "blackwing", },
	   ["DEADMINES"] = { "dead ?mines", "death ?mines", "dms?", "vc", "vancleef", "mms?", "morte ?mines?", },
	   ["DIREMAUL"] = { "ht", "ht .*nord", "ht .*ouest", "ht .*est", "ht .*east", " hache ?tripe ", },
	   ["GNOMEREGAN"] ={ "gnomeregan", " gnome", },
	   ["LBRS"] = { "lower .*spire", "lower .*blackrock", "lbrs", "basse", "pic", },
	   ["MARAUDON"] = { "mau?rau?don", },
	   ["MOLTENCORE"] ={ "mc", "molten ?core", "ragnaros", "rag", "coeur de magma", },
	   ["MONASTERY"] = { "monast\195\168re \195\169carlate", "mona", "monast\195\168re", "armurerie", "cathedrale", "mograine", "monastere", "cath\195\169drale", "cath\195\169", },
	   ["NAXXRAMAS"] = { "naxxramas", "naxx", },
	   ["ONYXIA"] = { "onyxia", "ony", },
	   ["RAGEFIRE"] = { "rage ?feu", },
	   ["RAZORFEN"] = { "Tranchebauge", "kraal", "krall", "souilles?", },
	   ["SCHOLOMANCE"] = { " sc?h?olo", " sc?h?olomance", },
	   ["SHADOWFANG"] = { "ombrecroc", },
	   ["STOCKADE"] = { "prisons?", },
	   ["STRATHOLME"] = { " strath", " starth ", " baron", "ecarlate", " strat ", "\195\169carlate", },
	   ["SUNKENTEMPLE"] = { "temple engloutie?", "temple", },
	   ["UBRS"] = { "upper *.spire", "upper *.blackrock", "ubrs", "urbs", "haute", "pic", },
	   ["ULDAMAN"] = { "ulda", "uldaman", },
	   ["WAILINGCAVES"] = { "lamentations?", "lams?", },
	   ["WARSONG"] = { "goulet", "ws", "warsong", "wsg", },
	   ["ZULFARRAK"] = { " zul [^g]", "zf", "farr?ak ", " mallet", " zul f", " zul $", },
	   ["ZULGURUB"] = { " zul g", "zg", "gurub", "hakkar", },
	   ["PVP"] = { "hordes?", "hordeux", "allis?", "alliance", "allianceux", "jcj", "pvp",},
	   ["QUEST"] = { "qu\195\170tes?", "quetes?", },
	   ["INSTANCE"] = { " instan[zc]", " run ", "instance" },
	   ["ANYTHING"] = { "n'importe", },
	  },
	  ["ZONE"] = {
	   ["ARATHIHIGHLANDS"] = { "Hautes?-? ?terres? d'Arathi", "hautes?", "terres?", },
	   ["BARRENS"] = { "barrens", "tarrides?", "croisee", "crois\195\169e", "crois\195\169", },
	   ["DUSKWOOD"] = { "duskwood", "bois de la p\195\169nombre", "p\195\169nombre", "darkshire", "penombre", },
	   ["DESOLACE"] = { "desolace", "d\195\169solace",},
	   ["EASTPLAGUE"] = { "malterre de l'est", "malterre", "est", "l'est", },
	   ["ELWYN"] = { "hogger", "elwyn", },
	   ["HILLSBRAD"] = { "southshore", "hillsbrad", "dalaran", },
	   ["HINTERLANDS"] = { "hinterlands?", "revantusk", "jintha?'a?lor", },
	   ["REDRIDGE"] = { "redridge", "stonewatch", "lakeshire", "rr", "carmines", },
	   ["SEARINGGORGE"] = { "gorges?", "vents?", },
	   ["STRANGLE"] = { "strangleronce", "strangle" },
	   ["TANARIS"] = { "tanaris", },
	   ["WESTFALL"] = { "marche de l'ouest", "wf", "westfall", "marche de", },
	   ["WESTPLAGUE"] = { "malterre de l'ouest", "malterre", "ouest", "l'ouest", },
	   ["WETLANDS"] = { "paluns", "Palun",},
	   ["WINTERSPRING"] = { "winterspring", "berceau", "l'hiver", "berceau-de-l'hiver", },
	   ["SILITHUS"] = { "silithus", },
	   ["FERALAS"] = { "feralas", },
	   ["FELWOOD"] = { "gangrebois", },
	   ["AZSHARA"] = { "azshara", },
