...
--	
--	$Id: localization.lua 3720 2006-06-26 21:18:26Z karlkfi $
--	$Rev: 3720 $
--	$LastChangedBy: karlkfi $
--	$Date: 2006-06-26 16:18:26 -0500 (Mon, 26 Jun 2006) $
--]]
...
if (MCom_Update) then
	...
	--
	--------------------------------------------------
	MCOM_CHAT_COM_HELP_USAGE		=	"Click on any of the current values to change them.\nClick on a command to insert it into the chat entry area."
	MCOM_CHAT_COM_ALIAS			= "Command aliases: \124c00FFC000%s\124r";
	MCOM_CHAT_COM_COMMANDS		= "Commands:\n-Command Name-\n\124c00FFC000command/alias\124r - type \124c0000FF00(state)\124r\ndetails";
	...
	MCOM_CHAT_COM_K_X = "\124r\124c%sExample\124r\124c0000FF00";
	...
	MCOM_CHAT_COM_USAGE_B_E		=	"On "..MCOM_BOOLT..MCOM_SIMPLET.." options, if you do not pass anything the command will be executed, if you pass "..MCOM_CHAT_COM_B..", then that value will be set.";
