...
STRANQ_STRINGS.HUNTER = "J\195\164ger";
STRANQ_STRINGS.TRANQ = "Einlullender Schuss";
STRANQ_STRINGS.SPELLSELF = "Ihr wirkt "..STRANQ_STRINGS.TRANQ.." auf (.+).";
STRANQ_STRINGS.SPELLOTHER = "(.+) wirkt "..STRANQ_STRINGS.TRANQ.." auf (.+).";
STRANQ_STRINGS.SPELLOTHERMISS = STRANQ_STRINGS.TRANQ.." von ([^%s]+) verfehlt (.+)";
STRANQ_STRINGS.FRENZY = "Raserei";
STRANQ_STRINGS.FAILSELF = "(.+) kann dies nicht bannen: "..STRANQ_STRINGS.FRENZY..".";
STRANQ_STRINGS.FAILOTHER = "(.+) kann (.+)s "..STRANQ_STRINGS.FRENZY.." nicht bannen.";
STRANQ_STRINGS.GAINFRENZY = "(.+) bekommt '"..STRANQ_STRINGS.FRENZY.."'.";
STRANQ_STRINGS.REMOVED = "'"..STRANQ_STRINGS.FRENZY.."' von (.+) wurde entfernt.";
STRANQ_STRINGS.FRENZYEMOTE = "ger\195\164t in .*Raserei!";

STRANQ_STRINGS.PANIC = "Panik";
STRANQ_STRINGS.TIMELAPSE = "Zeitraffer";
STRANQ_STRINGS.TIMESTOP = "Zeitstopp";
STRANQ_STRINGS.WYVERNSTING = "Stich des Flügeldrachen";
STRANQ_STRINGS.MANABURN = "Manabrand";
STRANQ_STRINGS.MINDFLAY = "Gedankenschinden";
STRANQ_STRINGS.CAUSEINSANITY = "Wahnsinn verursachen";

STRANQ_STRINGS.FEAR = " furcht%a+";
STRANQ_STRINGS.STUN = " bet\195\164ub%a+";
STRANQ_STRINGS.FLEE = " flücht%a+";

-- mob names
STRANQ_STRINGS.MAGMADAR = "Magmadar";
STRANQ_STRINGS.CHROMAGGUS = "Chromaggus";
STRANQ_STRINGS.MAWS = "Maws";
STRANQ_STRINGS.PRINCESS_HUHURAN = "Prinzessin Huhuran";
STRANQ_STRINGS.FLAMEGOR = "Flammenmaul";
STRANQ_STRINGS.GLUTH = "Gluth";
STRANQ_STRINGS.QIRAJI_SLAYER = "Vollstrecker der Qiraji";
STRANQ_STRINGS.DEATH_TALON_SEETHER = "Schnauber der Todeskrallen";
STRANQ_STRINGS.VEKNISS_DRONE = "Drohne der Vekniss";
STRANQ_STRINGS.VEKNISS_SOLDIER = "Soldat der Vekniss";
