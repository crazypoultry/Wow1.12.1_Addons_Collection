...
STRANQ_STRINGS.HUNTER = "Chasseur";
STRANQ_STRINGS.TRANQ = "Tir tranquillisant";
STRANQ_STRINGS.SPELLSELF = "Vous lancez "..STRANQ_STRINGS.TRANQ.." sur (.+).";
STRANQ_STRINGS.SPELLOTHER = "(.+) lance "..STRANQ_STRINGS.TRANQ.." sur (.+).";
STRANQ_STRINGS.SPELLOTHERMISS = "([^%s]+) voit son "..STRANQ_STRINGS.TRANQ.." manquer (.+)";
STRANQ_STRINGS.FRENZY = "fr\195\169n\195\169sie";
STRANQ_STRINGS.FAILSELF = "Vous n'avez pas réussi à dissiper le "..STRANQ_STRINGS.FRENZY.." de (.+).";
STRANQ_STRINGS.FAILOTHER = "(.+) n'a pas réussi à dissiper le "..STRANQ_STRINGS.FRENZY.." de (.+).";
STRANQ_STRINGS.GAINFRENZY = "(.+) gagne "..STRANQ_STRINGS.FRENZY..".";
STRANQ_STRINGS.REMOVED = "(.+) n'est plus sous l'influence de "..STRANQ_STRINGS.FRENZY..".";
STRANQ_STRINGS.FRENZYEMOTE = STRANQ_STRINGS.FRENZY;			-- Could use a better translation

STRANQ_STRINGS.PANIC = "Panique";
STRANQ_STRINGS.TIMELAPSE = "Trou de temps";
STRANQ_STRINGS.TIMESTOP = "Arrêt du temps";
STRANQ_STRINGS.WYVERNSTING = "Piqûre de wyverne";
STRANQ_STRINGS.MANABURN = "Brûlure de mana";
STRANQ_STRINGS.MINDFLAY = "Fouet mental";
STRANQ_STRINGS.CAUSEINSANITY = "Rendre fou";

STRANQ_STRINGS.FEAR = " effray%a+";
STRANQ_STRINGS.STUN = " \195\169tourd%a+";
STRANQ_STRINGS.FLEE = " fui%a+";
