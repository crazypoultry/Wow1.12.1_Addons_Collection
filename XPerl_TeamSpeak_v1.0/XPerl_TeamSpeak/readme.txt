...
To add support for another unit frame:
        ...
        function myPlayerFunc(speaking)
                XPerl_ActivateSpeaker(myAnchorFrame, speaking, anchor)
        end
        ...
        function myPartyFunc(name, speaking)
                ...
                if (id) then
                        ...
                        XPerl_ActivateSpeaker(frame, speaking, anchor)
                end
        end
...
For XPerl_ActivateSpeaker(frame, speaking, anchor). If anchor is not specificed
it will default to "LEFT"
