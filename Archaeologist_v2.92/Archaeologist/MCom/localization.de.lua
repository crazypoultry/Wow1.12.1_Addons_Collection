...
--	By: StarDust
--	
--	$Id: localization.de.lua 3042 2006-02-06 15:14:48Z stardust $
--	$Rev: 3042 $
--	$LastChangedBy: stardust $
--	$Date: 2006-02-06 09:14:48 -0600 (Mon, 06 Feb 2006) $
--]]
...
if ( GetLocale() == "deDE" ) then
	...
	if (MCom_Update) then
		...
		--
		--------------------------------------------------
		MCOM_CHAT_COM_HELP_USAGE	= "Klicke auf irgendeinen der Werte um jene zu \195\164ndern.\nKlicke auf einen Befehl, um jenen in die Chat-Eingabeaufforderung einzuf\195\188gen."
		MCOM_CHAT_COMMAND_ALIAS		= "Alternative Befehle: \124c00FFC000%s\124r";
		MCOM_CHAT_COM_COMMANDS		= "Befehle:\n-Name des Befehls-\n\124c00FFC000Befehl/Alias\124r - Typ \124c0000FF00(Status)\124r\nDetails";
		...
		MCOM_CHAT_COM_K_A		= "O:%s";
		MCOM_CHAT_COM_K_X		= "\124r\124c%sBeispiel\124r\124c0000FF00";
		...
		MCOM_CHAT_COM_USAGE_B_E		= "Bei der "..MCOM_BOOLT..MCOM_SIMPLET.." Option: wenn nichts angegeben wird, wird der Befehl ausgef\195\188hrt; wenn "..MCOM_CHAT_COM_B.." angegeben wird, wird jener Wert gesetzt.";
