...
--------------------------------------------------
	...
	Addon: Archaeologist
	Language: French
	Translation by: Sasmira and WLMitch
	Last Update: 4/4/2006
--------------------------------------------------
]]--

Localization.RegisterAddonStrings("frFR", "Archaeologist", {
	...
	ARCHAEOLOGIST_CONFIG_PRESETS = "Pr\195\169r\195\169glage";
	ARCHAEOLOGIST_CONFIG_SET = "R\195\169gler";
	...
	ARCHAEOLOGIST_CONFIG_HPMPLARGEFONT_INFO = "Police du Texte Joueur/Cible.";
	...
	ARCHAEOLOGIST_CONFIG_HPMPSMALLFONT_INFO = "Police du Texte Familier/Groupe";
