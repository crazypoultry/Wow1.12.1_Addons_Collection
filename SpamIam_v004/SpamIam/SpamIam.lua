...
function SPAMIAM_Localize()
	if (GetLocale() == "frFR") then
		...
		SPAMIAM_INIT1 = "SpamIam ";
		SPAMIAM_V = "v";
		SPAMIAM_INIT2 = " charg/195/169. Ecrivez /SpamIam ou /sia pour afficher les options.";
		SPAMIAM_STATUS1 = "[SpamIam est actuellement ";
		SPAMIAM_STATUS2 = "]";
		...
		SPAMIAM_USAGE8 = "  silencieux - D/195/169sactive les Sons des Erreurs";
		SPAMIAM_USAGE9 = "  bruyant - Active les Sons des Erreurs";
		...
		SPAMIAM_SPEECHTEXT1 = "SpamIam: Sons des Erreurs D/195/169sactiv/195/169.";
		SPAMIAM_SPEECHTEXT2 = "SpamIam: Sons des Erreurs Activ/195/169.";
	...
	elseif (GetLocale() == "deDE") then
		...
		SPAMIAM_USAGE8 = " speechoff - deaktiviert Sprachfehlermeldungen";
		SPAMIAM_USAGE9 = " speechon - aktiviert Sprachfehlermeldungen";
