...
function TNE_LowHealth_OnLoad()
  ...
  TNE_LowHealth_Default_ManaEmote = false
  TNE_LowHealth_Default_UseAltTextures = false
  ...
  TNE_LowHealth_ManaEmote = TNE_LowHealth_Default_ManaEmote
  TNE_LowHealth_Thresholds = TNE_LowHealth_Default_Thresholds
  TNE_LowHealth_UseAltTextures = TNE_LowHealth_Default_UseAltTextures

  TNE_LowHealth_HealthFrame = LowHealthFrame
  TNE_LowHealth_ManaFrame = OutOfControlFrame
...
function TNE_LowHealth_ApplySettings()
  ...
  TNE_LowHealth_FlashFrameStop(TNE_LowHealth_HealthFrame, "UNIT_HEALTH")
  TNE_LowHealth_FlashFrameStop(TNE_LowHealth_ManaFrame, "UNIT_MANA")

  -- register or unregister events
  if (TNE_LowHealth_Enabled) then
    TNE_LowHealth_HealthFrame = TNE_LowHealth_UseAltTextures and LowHealthWarningFrameAltTexture1 or LowHealthFrame
    frame:RegisterEvent("UNIT_DISPLAYPOWER")
    if (TNE_LowHealth_HealthEnabled or TNE_LowHealth_SoundEnabled) then
      frame:RegisterEvent("UNIT_HEALTH")
    end
    TNE_LowHealth_ManaCheck()
    TNE_LowHealth_ManaFrame = TNE_LowHealth_UseAltTextures and LowHealthWarningFrameAltTexture2 or OutOfControlFrame
  else
...
function TNE_LowHealth_ManaCheck()
  ...
  if (TNE_LowHealth_ManaEnabled and UnitPowerType("player") == 0) then
    ...
    TNE_LowHealth_FlashFrameStop(TNE_LowHealth_ManaFrame, mana)
  end
end
