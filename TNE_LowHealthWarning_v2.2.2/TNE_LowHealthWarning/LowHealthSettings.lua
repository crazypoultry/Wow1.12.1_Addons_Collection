...
function TNE_LowHealthSettings_ApplySettings()
  ...
  TNE_LowHealth_UseAltTextures = getglobal(frame.. "General".. ocb.. "2"):GetChecked() or false
  ...
  TNE_LowHealth_ManaEmote = getglobal(frame.. "Mana".. ocb.. "4"):GetChecked() or false
...
function TNE_LowHealthSettings_PrepareValues(default)
  ...
  local checkButtons = {
    ["General"] = {
      ...
      [2] = getglobal("TNE_LowHealth".. default.. "_UseAltTextures"),
    },
    ["Sound"] = {
    ...
    ["Mana"] = {
      ...
      [4] = getglobal("TNE_LowHealth".. default.. "_ManaEmote"),
    },
  }
