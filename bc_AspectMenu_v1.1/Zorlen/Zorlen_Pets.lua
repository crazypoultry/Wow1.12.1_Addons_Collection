...
Zorlen_Pets_FileBuildNumber = 678
...
function zDashAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Dash)
end

function zDashAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Dash)
end
...
function zDiveAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Dive)
end


function zDiveAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Dive)
end


function zCharge()
	return Zorlen_castPetSpell(LOCALIZATION_ZORLEN_Charge, 35)
end

function zChargeAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Charge)
end

function zChargeAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Charge)
end
...
function zBiteAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Bite)
end

function zBiteAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Bite)
end
...
function zClawAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Claw)
end

function zClawAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Claw)
end
...
function zCowerAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Cower)
end

function zCowerAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Cower)
end
...
function zGrowlAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Growl)
end

function zGrowlAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Growl)
end
...
function zProwlAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Prowl)
end

function zProwlAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Prowl)
end
...
function zScreechAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Screech)
end

function zScreechAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Screech)
end
...
function zThunderstompAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Thunderstomp)
end

function zThunderstompAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Thunderstomp)
end
...
function zFuriousHowlAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_FuriousHowl)
end

function zFuriousHowlAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_FuriousHowl)
end
...
function zShellShieldAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_ShellShield)
end

function zShellShieldAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_ShellShield)
end
...
function zLightningBreathAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_LightningBreath)
end

function zLightningBreathAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_LightningBreath)
end
...
function zScorpidPoisonAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_ScorpidPoison)
end

function zScorpidPoisonAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_ScorpidPoison)
end
...
function zFireShieldAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_FireShield)
end

function zFireShieldAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_FireShield)
end
...
function zBloodPactAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_BloodPact)
end

function zBloodPactAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_BloodPact)
end
...
function zFireboltAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Firebolt)
end

function zFireboltAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Firebolt)
end
...
function zPhaseShiftAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_PhaseShift)
end

function zPhaseShiftAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_PhaseShift)
end
...
function zAutoConsumeShadows(PetHealthPercent)
	...
	if Zorlen_notInCombat() and UnitCreatureFamily("pet") == LOCALIZATION_ZORLEN_Voidwalker and UnitHealth("pet") > 0 and UnitHealth("pet") / UnitHealthMax("pet") <= PetHP / 100 and not Zorlen_checkBuff("Spell_Shadow_AntiShadow", "pet") then
		return Zorlen_castPetSpell(LOCALIZATION_ZORLEN_ConsumeShadows, nil, nil, 85, 150, 215, 285, 380, 480)
	end
	return false
end
...
function zAutoSacrifice(PlayerHealthPercent, PetHealthPercent, OnlyIfYourTargetIsTargetingYou)
	...
	if Zorlen_inCombat() and UnitCreatureFamily("pet") == LOCALIZATION_ZORLEN_Voidwalker and UnitHealth("pet") > 0 and (UnitHealth("pet") / UnitHealthMax("pet") <= PetHP / 100 or ((not OnlyIfYourTargetIsTargetingYou or UnitIsUnit("player", "targettarget")) and UnitHealth("player") / UnitHealthMax("player") <= PlayerHP / 100)) and not Zorlen_checkDebuffByName(LOCALIZATION_ZORLEN_Banish, "pet") then
		return Zorlen_castPetSpell(LOCALIZATION_ZORLEN_Sacrifice)
	end
	return false
end
...
function zSufferingAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Suffering)
end

function zSufferingAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Suffering)
end
...
function zTormentAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Torment)
end

function zTormentAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Torment)
end
...
function zDevourMagicAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_DevourMagic)
end

function zDevourMagicAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_DevourMagic)
end
...
function zParanoiaAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Paranoia)
end

function zParanoiaAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Paranoia)
end
...
function zSpellLockAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_SpellLock)
end

function zSpellLockAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_SpellLock)
end
...
function zTaintedBloodAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_TaintedBlood)
end

function zTaintedBloodAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_TaintedBlood)
end
...
function zLashOfPainAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_LashOfPain)
end

function zLashOfPainAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_LashOfPain)
end
...
function zSeductionAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_Seduction)
end

function zSeductionAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_Seduction)
end
...
function zSoothingKissAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_SoothingKiss)
end

function zSoothingKissAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_SoothingKiss)
end
...
function zLesserInvisibilityAutocastOn()
	return Zorlen_PetSpellAutocastOn(LOCALIZATION_ZORLEN_LesserInvisibility)
end

function zLesserInvisibilityAutocastOff()
	return Zorlen_PetSpellAutocastOff(LOCALIZATION_ZORLEN_LesserInvisibility)
end
