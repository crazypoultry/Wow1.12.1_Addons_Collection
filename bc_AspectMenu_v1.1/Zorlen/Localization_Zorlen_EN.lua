...
-- All file Localization
	LOCALIZATION_ZORLEN_EatMacroName = "Zorlen Eat"
	LOCALIZATION_ZORLEN_DrinkMacroName = "Zorlen Drink"
	LOCALIZATION_ZORLEN_Conjured = "Conjured"
	LOCALIZATION_ZORLEN_Water = "Water"
	LOCALIZATION_ZORLEN_AllConjuredWater = "Conjured.*Water"
	LOCALIZATION_ZORLEN_well_fed = "well fed"
	LOCALIZATION_ZORLEN_HitsOrCritsArray = {"Your (.+) hits (.*) for (%d+)", "Your (.+) crits (.*) for (%d+)"}
	LOCALIZATION_ZORLEN_EnemyDies = "^(.*) dies%.$"
	LOCALIZATION_ZORLEN_Rank = "Rank"
	LOCALIZATION_ZORLEN_sit = "sit"
	LOCALIZATION_ZORLEN_You_dodge = "(.*) attacks. You dodge."
	LOCALIZATION_ZORLEN_immune = "Your (.+) failed. (.*) is immune."
	LOCALIZATION_ZORLEN_no_weapons_equipped = "You fail to perform (.+): Target has no weapons equipped."
	LOCALIZATION_ZORLEN_dodged = "Your (.+) was dodged by (.*)."
	LOCALIZATION_ZORLEN_dodges = "You attack. (.*) dodges."
	LOCALIZATION_ZORLEN_pet_is_not_dead = "Your pet is not dead"
	LOCALIZATION_ZORLEN_pet_is_dead = "Your pet is dead"
	LOCALIZATION_ZORLEN_A_more_powerful_spell_is_already_active = "You fail to perform (.+): A more powerful spell is already active."
	LOCALIZATION_ZORLEN_Asleep = "Asleep"
	LOCALIZATION_ZORLEN_RequiresLevel = "Requires Level"
	
	LOCALIZATION_ZORLEN_GreaterHealingWard = "Greater Healing Ward"
	LOCALIZATION_ZORLEN_LavaSpoutTotem = "Lava Spout Totem"
	
	LOCALIZATION_ZORLEN_HealingBonusWordsArray = {"Healing", "Healing Spells", "Increases Healing"}
	LOCALIZATION_ZORLEN_HealingBonusPhraseArray = {"Increases healing done by spells and effects by up to (%d+)%."}
	
	LOCALIZATION_ZORLEN_SpellDamageAndHealingBonusWordsArray = {"Healing and Spell Damage", "Damage and Healing Spells", "Spell Damage and Healing"}
	LOCALIZATION_ZORLEN_SpellDamageAndHealingBonusPhraseArray = {"Increases damage and healing done by magical spells and effects by up to (%d+)%."}
	
	LOCALIZATION_ZORLEN_SpellDamageBonusWordsArray = {"Spell Damage"}
	LOCALIZATION_ZORLEN_SpellDamageBonusPhraseArray = {"Increases damage done by magical spells and effects by up to (%d+)%."}
	LOCALIZATION_ZORLEN_BrilliantWizardOil = "Brilliant Wizard Oil" -- 36 Spell Damage
	LOCALIZATION_ZORLEN_WizardOil = "Wizard Oil" -- 24 Spell Damage
	LOCALIZATION_ZORLEN_LesserWizardOil = "Lesser Wizard Oil" -- 16 Spell Damage
	LOCALIZATION_ZORLEN_MinorWizardOil = "Minor Wizard Oil" -- 8 Spell Damage
	LOCALIZATION_ZORLEN_SupremePower = "Supreme Power" -- 150 Spell Damage
	LOCALIZATION_ZORLEN_GreaterArcaneElixir = "Greater Arcane Elixir" -- 35 Spell Damage
	LOCALIZATION_ZORLEN_ArcaneElixir = "Arcane Elixir" -- 20 Spell Damage
	
	LOCALIZATION_ZORLEN_ShadowDamageBonusWordsArray = {"Shadow Damage"}
	LOCALIZATION_ZORLEN_ShadowDamageBonusPhraseArray = {"Increases damage done by Shadow spells and effects by up to (%d+)%."}
	LOCALIZATION_ZORLEN_ShadowPower = "Shadow Power" -- 40 Shadow Damage
	
-- Battleground Names
	LOCALIZATION_ZORLEN_WarsongGulch = "Warsong Gulch"
	LOCALIZATION_ZORLEN_AlteracValley = "Alterac Valley"
	LOCALIZATION_ZORLEN_ArathiBasin = "Arathi Basin"
	
-- Raid Target Names
	LOCALIZATION_ZORLEN_WhiteSkull = "White Skull"
	LOCALIZATION_ZORLEN_RedX = "Red X"
	LOCALIZATION_ZORLEN_BlueSquare = "Blue Square"
	LOCALIZATION_ZORLEN_WhiteCrescentMoon = "White Crescent Moon"
	LOCALIZATION_ZORLEN_GreenTriangle = "Green Triangle"
	LOCALIZATION_ZORLEN_PurpleDiamond = "Purple Diamond"
	LOCALIZATION_ZORLEN_OrangeCircle = "Orange Circle"
	LOCALIZATION_ZORLEN_YellowStar = "Yellow Star"



-- Food Item Tool Tip Text:
	LOCALIZATION_ZORLEN_FoodToolTipTextAny = "Use: Restores.*(%d+).*health.*(%d+) sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText3180 = "Use: Restores 3180 health over 30 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText2148 = "Use: Restores 2148 health over 30 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText1392 = "Use: Restores 1392 health over 30 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText874 = "Use: Restores 874 health over 27 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText552 = "Use: Restores 552 health over 24 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText243 = "Use: Restores 243 health over 21 sec.*eating"
	LOCALIZATION_ZORLEN_FoodToolTipText61 = "Use: Restores 61 health over 18 sec.*eating"
-- Drink Item Tool Tip Text:
	LOCALIZATION_ZORLEN_DrinkToolTipTextAny = "Use: Restores.*(%d+).*mana.*(%d+) sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText4200 = "Use: Restores 4200 mana over 30 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText2934 = "Use: Restores 2934 mana over 30 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText1992 = "Use: Restores 1992 mana over 30 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText1344 = "Use: Restores 1344 mana over 27 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText835 = "Use: Restores 835 mana over 24 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText436 = "Use: Restores 436 mana over 21 sec.*drinking"
	LOCALIZATION_ZORLEN_DrinkToolTipText151 = "Use: Restores 151 mana over 18 sec.*drinking"
...
-- Warlock Pets
	LOCALIZATION_ZORLEN_Felhunter = "Felhunter"
	LOCALIZATION_ZORLEN_Imp = "Imp"
	LOCALIZATION_ZORLEN_Succubus = "Succubus"
	LOCALIZATION_ZORLEN_Voidwalker = "Voidwalker"
...
-- Zorlen_Hunter.lua file Localization
	LOCALIZATION_ZORLEN_FeedPet = "Feed Pet"
...
-- Zorlen_Warlock.lua file Localization
	LOCALIZATION_ZORLEN_SoulSiphon = "Soul Siphon"
	LOCALIZATION_ZORLEN_SeedOfCorruption = "Seed of Corruption"
	LOCALIZATION_ZORLEN_FelArmor = "Fel Armor"
	LOCALIZATION_ZORLEN_RitualOfSouls = "Ritual of Souls"
	LOCALIZATION_ZORLEN_Soulshatter = "Soulshatter"
	LOCALIZATION_ZORLEN_Incinerate = "Incinerate"
	LOCALIZATION_ZORLEN_UnstableAffliction = "Unstable Affliction"
	LOCALIZATION_ZORLEN_DemonicAegis = "Demonic Aegis"
	LOCALIZATION_ZORLEN_SummonFelGuard = "Summon Fel Guard"
	LOCALIZATION_ZORLEN_Shadowfury = "Shadowfury"
	
	LOCALIZATION_ZORLEN_Bane = "Bane"
...
-- Zorlen_Druid.lua file Localization
	...
	LOCALIZATION_ZORLEN_Swiftmend = "Swiftmend"



-- Zorlen_Mage.lua file Localization
	LOCALIZATION_ZORLEN_ConjuredCinnamonRoll = "Conjured Cinnamon Roll"
	LOCALIZATION_ZORLEN_ConjuredSweetRoll = "Conjured Sweet Roll"
	LOCALIZATION_ZORLEN_ConjuredSourdough = "Conjured Sourdough"
	LOCALIZATION_ZORLEN_ConjuredPumpernickel = "Conjured Pumpernickel"
	LOCALIZATION_ZORLEN_ConjuredRye = "Conjured Rye"
	LOCALIZATION_ZORLEN_ConjuredBread = "Conjured Bread"
	LOCALIZATION_ZORLEN_ConjuredMuffin = "Conjured Muffin"
	LOCALIZATION_ZORLEN_ConjuredCrystalWater = "Conjured Crystal Water"
	LOCALIZATION_ZORLEN_ConjuredSparklingWater = "Conjured Sparkling Water"
	LOCALIZATION_ZORLEN_ConjuredMineralWater = "Conjured Mineral Water"
	LOCALIZATION_ZORLEN_ConjuredSpringWater = "Conjured Spring Water"
	LOCALIZATION_ZORLEN_ConjuredPurifiedWater = "Conjured Purified Water"
	LOCALIZATION_ZORLEN_ConjuredFreshWater = "Conjured Fresh Water"
	LOCALIZATION_ZORLEN_ConjuredWater = "Conjured Water"
...
-- Zorlen_Priest.lua file Localization
	LOCALIZATION_ZORLEN_PowerInfusion = "Power Infusion"
	LOCALIZATION_ZORLEN_Lightwell = "Lightwell"
...
-- Zorlen_Warrior.lua file Localization
	LOCALIZATION_ZORLEN_Devastate = "Devastate"
	LOCALIZATION_ZORLEN_ImprovedWhirlwind = "Improved Whirlwind"
	LOCALIZATION_ZORLEN_FocusedRage = "Focused Rage"
	LOCALIZATION_ZORLEN_CommandingShout = "Commanding Shout"
	LOCALIZATION_ZORLEN_SpellReflection = "Spell Reflection"
	LOCALIZATION_ZORLEN_Intervene = "Intervene"
	LOCALIZATION_ZORLEN_VictoryRush = "Victory Rush"
	LOCALIZATION_ZORLEN_EndlessRage = "Endless Rage"
	LOCALIZATION_ZORLEN_Rampage = "Rampage"
	
	LOCALIZATION_ZORLEN_ImprovedBloodrage = "Improved Bloodrage"
...
-- Fire Immune MOB's
 -- Molten Core
	LOCALIZATION_ZORLEN_Firelord = "Firelord"
	LOCALIZATION_ZORLEN_Firewalker = "Firewalker"
	LOCALIZATION_ZORLEN_Flameguard = "Flameguard"
	LOCALIZATION_ZORLEN_LavaSpawn = "Lava Spawn"
	LOCALIZATION_ZORLEN_BaronGeddon = "Baron Geddon"
	LOCALIZATION_ZORLEN_Ragnaros = "Ragnaros"
 -- Upper Blackrock Spire
	LOCALIZATION_ZORLEN_PyroguardEmberseer = "Pyroguard Emberseer"
 -- Blackrock Depths
	LOCALIZATION_ZORLEN_Fireguard = "Fireguard"
	LOCALIZATION_ZORLEN_FireguardDestroyer = "Fireguard Destroyer"
	LOCALIZATION_ZORLEN_BlazingFireguard = "Blazing Fireguard"
	LOCALIZATION_ZORLEN_AmbassadorFlamelash = "Ambassador Flamelash"
	LOCALIZATION_ZORLEN_LordIncendius = "Lord Incendius"
 --Searing Gorge
	LOCALIZATION_ZORLEN_BlazingElemental = "Blazing Elemental"
	LOCALIZATION_ZORLEN_InfernoElemental = "Inferno Elemental"
 --Un'Goro Crater
	LOCALIZATION_ZORLEN_ScorchingElemental = "Scorching Elemental"
	LOCALIZATION_ZORLEN_LivingBlaze = "Living Blaze"
	LOCALIZATION_ZORLEN_Blazerunner = "Blazerunner"

-- Drain Life Immune MOB's
 -- Blackrock Depths
	LOCALIZATION_ZORLEN_MoltenWarGolem = "Molten War Golem"
	LOCALIZATION_ZORLEN_PanzorTheInvincible = "Panzor the Invincible"
 --Searing Gorge
	LOCALIZATION_ZORLEN_HeavyWarGolem = "Heavy War Golem"
	LOCALIZATION_ZORLEN_FaultyWarGolem = "Faulty War Golem"
	LOCALIZATION_ZORLEN_TemperedWarGolem = "Tempered War Golem"
	LOCALIZATION_ZORLEN_RagereaverGolem = "Ragereaver Golem"
