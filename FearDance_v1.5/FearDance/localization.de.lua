...
if GetLocale() == "deDE" then
	...
	FEARDANCE_BERSERKER_RAGE = "Berserkerwut";
	FEARDANCE_STANCES = {"Kampfhaltung", "Verteidigungshaltung", "Berserkerhaltung"};
	FEARDANCE_COOLDOWN = FEARDANCE_HEADER .. "Berserkerwut hat noch %.1f Sekunden Abklingzeit.";
