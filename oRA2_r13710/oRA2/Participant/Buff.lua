...
local L = AceLibrary("AceLocale-2.0"):new("oRAPBuff")
...
L:RegisterTranslations("zhCN", function() return {
	...
	["ShadowProtection"] = "暗影防护",
	["PrayerofShadowProtection"] = "防护暗影祷言",
	["PowerWordShield"] = "真言术:盾",
	["SoulstoneResurrection"] = "灵魂石冷却",
	["DivineSpirit"] = "神圣之灵",
	["PrayerOfSpirit"] = "精神祷言",
	["Thorns"] = "荆棘术",
	["FearWard"] = "防护恐惧结界",
...
L:RegisterTranslations("frFR", function() return {
	...
	["PrayerOfFortitude"] = "Pri\195\169re de robustesse",
...
function oRAPBuff:OnInitialize()
