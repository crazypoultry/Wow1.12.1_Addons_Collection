...
local L = AceLibrary("AceLocale-2.0"):new("oRAOResurrection")
...
function oRAOResurrection:OnInitialize()
...
function oRAOResurrection:SetupFrames()
	if not self.resframe then
		...
		resframe:SetScript("OnDragStart", function() self["resframe"]:StartMoving() end)
