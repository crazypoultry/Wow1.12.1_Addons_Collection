...
local L = AceLibrary("AceLocale-2.0"):new("oRALReady")
...
L:RegisterTranslations("zhCN", function() return {
	...
	["Close"] = "关闭",
	["<CTRaid> %s has performed a ready check."] = "<CTRaid> %s 已经检查",
	["AFK: "] = "暂离: ",
	["Not Ready: "] = "未就绪",
	["Yes: %d No: %d AFK: %d"] = "是: %d 否: %d 暂离: %d",
	["Vote Results for: "] = "投票结果",
	["<CTRaid> %s has performed a vote: %s"] = "<CTRaid> %s 已经投票 vote: %s",
	["Vote"] = "投票",
	["vote"] = "投票",
	["Perform a vote."] = "进行投票",
	["<vote>"] = "投票",
...
oRALReady.consoleOptions = {
	...
	args = {
		[L["check"]] = {
			...
			disabled = function() return not oRALReady:IsValidRequest() end,
		},
		[L["vote"]] = {
...
function oRALReady:OnInitialize()
