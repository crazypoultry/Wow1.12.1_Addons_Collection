...
local L = AceLibrary("AceLocale-2.0"):new("oRALDurability")
...
oRALDurability.consoleOptions = {
	...
	args = {
		[L["check"]] = {
			...
			disabled = function() return not oRALDurability:IsValidRequest() end,
		},
	}
}
...
function oRALDurability:OnInitialize()
