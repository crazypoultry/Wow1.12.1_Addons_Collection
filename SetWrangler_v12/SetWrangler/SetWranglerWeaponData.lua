...
function SetWrangler_MakeWeaponData()
	...
	partInfo	= SW_TEXT_HAND.." - "..SW_AREA_UBRS;
	partStats	= SW_TEXT_INST_HEADER.."\n"
	...
	partInfo	= SW_TEXT_OHAND.." - "..SW_AREA_UBRS;
	partStats	= SW_TEXT_INST_HEADER.."\n"
				  ..SW_WHITE_OPEN..SW_AREA_UBRS.."\n\n"..SW_LINK_COLOR_CLOSE
				  ..SW_TEXT_DROP_HEADER.."\n"
				  ..SW_WHITE_OPEN
...
partLink	= "item:13262:0:0:0";
	partInfo	= SW_TEXT_HAND.."\n";
	classData.aSetData[setIndex].aPartData[3]	= SetWrangler_MakePartData(partLink, partInfo);
	
		
	partLink	= "item:22630:0:0:0";
	partInfo	= SW_TEXT_HAND.."\n";
	classData.aSetData[setIndex].aPartData[4]	= SetWrangler_MakePartData(partLink, partInfo);
	

partLink	= "item:22631:0:0:0";
	partInfo	= SW_TEXT_HAND.."\n";
	classData.aSetData[setIndex].aPartData[5]	= SetWrangler_MakePartData(partLink, partInfo);	
	

partLink	= "item:22632:0:0:0";
	partInfo	= SW_TEXT_HAND.."\n";
	classData.aSetData[setIndex].aPartData[6]	= SetWrangler_MakePartData(partLink, partInfo);


partLink	= "item:23051:0:0:0";
	partInfo	= SW_TEXT_HAND.."\n";
	classData.aSetData[setIndex].aPartData[7]	= SetWrangler_MakePartData(partLink, partInfo);	
	
	partLink	= "item:17782:0:0:0";
	partInfo	= SW_TEXT_NECK.."\n";
	classData.aSetData[setIndex].aPartData[8]	= SetWrangler_MakePartData(partLink, partInfo);
