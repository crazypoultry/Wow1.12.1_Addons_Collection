...
function CleanMinimapOptions_Refresh()
  ...
  CMMToggleMinimapBorder:SetChecked(CleanMinimapConfig[CleanMinimap_player].border);
  CMMSliderOpacity:SetValue(CleanMinimapConfig[CleanMinimap_player].alpha * 100);
  CMMSliderSize:SetValue(CleanMinimapConfig[CleanMinimap_player].scale * 100);
...
function CleanMinimapOptions_EnableButtons()
    if (CleanMinimapConfig[CleanMinimap_player].on) then
	  ...
	  CMMToggleMinimapBorder:Enable();
      CMMToggleMinimapBorderText:SetTextColor(NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b);      
	  ...
	  CMMSliderSizeThumb:Show();
      CMMSliderSizeText:SetTextColor(NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b);
      CMMSliderSizeTextUpdate:SetTextColor(NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b);
	  ...
	  CMMToggleMinimapBorder:Disable();
      CMMToggleMinimapBorderText:SetTextColor(GRAY_FONT_COLOR.r, GRAY_FONT_COLOR.g, GRAY_FONT_COLOR.b);
	  ...
	  CMMSliderSizeThumb:Hide();
      CMMSliderSizeText:SetTextColor(GRAY_FONT_COLOR.r, GRAY_FONT_COLOR.g, GRAY_FONT_COLOR.b);
      CMMSliderSizeTextUpdate:SetTextColor(GRAY_FONT_COLOR.r, GRAY_FONT_COLOR.g, GRAY_FONT_COLOR.b);
