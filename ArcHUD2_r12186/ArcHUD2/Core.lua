...
function ArcHUD:OnInitialize()
	...
	self:LevelDebug(d_notice, "Setting up TargetHUD globals")
	...
	self:LevelDebug(d_notice, "Setting up NamePlate globals")
	self.NamePlates = {}
	...
	self:LevelDebug(d_notice, "Initializing nameplates")
	...
	self:LevelDebug(d_notice, "Updating fonts for locale")
...
function ArcHUD:OnProfileEnable()
	...
	if(self.db.profile.NamePlates) then
		self:LevelDebug(d_notice, "Nameplates enabled. Showing frames and starting update timers")
		...
		self:LevelDebug(d_notice, "Nameplates not enabled.")
		self:UnregisterMetro("Enable_player")
		self:UnregisterMetro("Enable_pet")
