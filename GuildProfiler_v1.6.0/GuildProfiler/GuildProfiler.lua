...
local rpgoGP_DATE			="August 22, 2006";
local rpgoGP_PROVIDER		="rpgo";
local rpgoGP_VERSION		="1.6.0";
local rpgoGP_PROFILEDB		="1.6.0";
--	//////////////////////////////////////////////
...
local rpgoAddonsHelpGP={"GuildProfileris an addon that extracts guild profile info including roster and rank info. This information can then be uploaded to your website to display your guild info.\n\n",};
