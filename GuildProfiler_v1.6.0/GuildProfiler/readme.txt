rpgo-GuildProfiler: Guild Profiler: WoW Addon
http://www.rpgoutfitter.com/GuildProfiler/

PREAMBLE:
rpgo-GuildProfiler is a World of Warcraft addon that grabs guild info shown on the Guild Roster.

DESCRIPTION:
rpgo-GuildProfiler is a World of Warcraft addon that grabs guild info shown on the in-game Guild Roster. This is saved in your savedvariables.lua in the myProfile block (from CharacterProfiler). This information can then be uploaded to a website to display your Guild Roster.

USAGE:
--SmartScan, Scan-as-you-Play. Play the game, have fun, and it learns the info. this should run hands-free, updating as needed. 
--'save' button. Social -> Guild -> Save Button (top left) 
--chat '/' commands with '/gp'
...
HISTORY:
full history available at: http://www.rpgoutfitter.com/GuildProfiler/#history
