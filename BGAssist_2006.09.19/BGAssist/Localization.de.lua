...
if ( GetLocale() == "deDE" ) then
	...
	DISPLAY_MENU_AUTOBGMINIMAP	= "Automatisch BG Minimap anzeigen, wenn Schlachtfeld betreten wird";
	...
	DISPLAY_MENU_ABTIMELEFTSHOW 	= "Zeit bis zum Ende anzeigen";
