...
-- TODO: "You receive loot: [Solid Stone]x2."
...
LT_REPUTATION_FACTION       = "Your ([%a%s]+) reputation has";
LT_REPUTATION_GAINED        = "increased by (%d+)";
LT_REPUTATION_LOST          = "decreased by (%d+)";
...
LT_SLASHCOMMAND_UPDATEVERSION       = "updateversion";
