...
MI_TXT_CONFIG_TITLE		= "MobInfo 2選項";
MI_TXT_WELCOME          = "歡迎使用MobInfo 2！";
MI_TXT_OPEN				= "開啟";
MI_TXT_CLASS			= "職業";
MI_TXT_HEALTH			= "生命值";
MI_TXT_MANA				= "法力值";
...
MI2_CHATMSG_MONSTEREMOTE = "想要轉身逃跑"
...
MI2_OPTIONS["MI2_OptCompactMode"] = 
	{ text = "簡潔模式"; help = "啟動怪物提示資訊的簡潔模式，一行顯示二筆資訊";
	info = "簡潔模式使用英文簡寫來顯示相關資訊。\n要禁止某行資訊顯示，需要同時禁止該行顯示的所有資料欄位。" }
...
MI2_OPTIONS["MI2_OptShowHealth"] = 
  { text = "生命值"; help = "顯示怪物的生命值 (目前/最大值)"; }

MI2_OPTIONS["MI2_OptShowMana"] = 
	{ text = "法力值"; help = "顯示怪物的法力/怒氣/能量值(目前/最大值)"; }
...
info = "在提示中，顯示目標怪物已記錄的，對各種類型的法術的抵抗和免疫之相關資料。" }    
...
MI2_OPTIONS["MI2_OptSaveBasicInfo"] = 
	...
	info = "基本怪物資訊包括：經驗值、怪物類型、計算：拾取、空拾取、布、金錢、物品的價值及物品掉落品質統計"; }
...
MI2_OPTIONS["MI2_MainOptionsFrameTab1"] = 
	{ text = "提示資訊選項"; help = "設定在提示資訊裏面，顯示的怪物資訊選項"; }

MI2_OPTIONS["MI2_MainOptionsFrameTab2"] = 
	{ text = "生命/法力值"; help = "設置目標框中顯示生命/法力值的選項"; }
