...
local MINOR_VERSION = "$Revision: 14557 $"
...
AL:RegisterTranslation("OneStorage", "zhCN", function() return { ["Quiver"] = "箭袋", ["Soul Bag"] = "灵魂袋", ["Container"] = "背包", ["Bag"] = "包裹", ["Player of Realm"] = "(.+) of (.+)" } end)
