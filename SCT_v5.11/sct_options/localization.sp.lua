...
SCT.LOCALS.OPTION_CHECK1 = { name = "Activa SCT", tooltipText = "Activa o desactiva Scrolling Combat Text"};
...
SCT.LOCALS.OPTION_MISC16 = {name="Animación"};
SCT.LOCALS.OPTION_MISC17 = {name="Spell Options"};
SCT.LOCALS.OPTION_MISC18 = {name="Texto", tooltipText = ""};
...
SCT.LOCALS.OPTION_SELECTION3 = { name="Letra", tooltipText = "Que letra usar", table = {[1] = SCT.LOCALS.FONTS[1].name,[2] = SCT.LOCALS.FONTS[2].name,[3] = SCT.LOCALS.FONTS[3].name,[4] = SCT.LOCALS.FONTS[4].name,[5] = SCT.LOCALS.FONTS[5].name}};
SCT.LOCALS.OPTION_SELECTION4 = { name="Controno Letra", tooltipText = "Que contorno letra usar", table = {[1] = "Ninguno",[2] = "Fino",[3] = "Grueso"}};
SCT.LOCALS.OPTION_SELECTION5 = { name="Letra Mensaje", tooltipText = "Que letra usar para mensajes", table = {[1] = SCT.LOCALS.FONTS[1].name,[2] = SCT.LOCALS.FONTS[2].name,[3] = SCT.LOCALS.FONTS[3].name,[4] = SCT.LOCALS.FONTS[4].name,[5] = SCT.LOCALS.FONTS[5].name}};
