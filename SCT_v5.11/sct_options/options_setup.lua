...
--SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC2.name] = {index = 2, tooltipText = SCT.LOCALS.OPTION_MISC2.tooltipText} -- old option will reuse later
--SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC3.name] = {index = 3, tooltipText = SCT.LOCALS.OPTION_MISC3.tooltipText} -- old option will reuse later
...
--SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC13.name] = {index = 13, tooltipText = SCT.LOCALS.OPTION_MISC13.tooltipText} -- old option will reuse later
