...
SCT.LOCALS.OPTION_CHECK1 = { name = "SCT", tooltipText = "Aktiviert den scrollenden Kampftext."};
...
SCT.LOCALS.OPTION_SELECTION3 = { name="Schriftart", tooltipText = "Welche Schriftart benutzen?", table = {[1] = SCT.LOCALS.FONTS[1].name,[2] = SCT.LOCALS.FONTS[2].name,[3] = SCT.LOCALS.FONTS[3].name,[4] = SCT.LOCALS.FONTS[4].name,[5] = SCT.LOCALS.FONTS[5].name}};
...
SCT.LOCALS.OPTION_SELECTION5 = { name="Nachrichten Schrifart", tooltipText = "Welche Schriftart bei Nachrichten benutzen?", table = {[1] = SCT.LOCALS.FONTS[1].name,[2] = SCT.LOCALS.FONTS[2].name,[3] = SCT.LOCALS.FONTS[3].name,[4] = SCT.LOCALS.FONTS[4].name,[5] = SCT.LOCALS.FONTS[5].name}};
