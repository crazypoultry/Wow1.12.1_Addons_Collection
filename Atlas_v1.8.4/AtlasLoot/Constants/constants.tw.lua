...
ATLASLOOT_FACTION_CENARION_EXPEDITION = "塞納里奧遠征軍";
ATLASLOOT_FACTION_SPOREGGAR = 			"斯博爾加";
...
ATLASLOOT_FACTION_THRALLMAR = 			"薩爾瑪";
...
ATLASLOOT_ZONE_HELLFIRE = 			"地域火半島";
ATLASLOOT_ZONE_HELLFIRE_W_PVP_AL = 	"Hellfire Fortifications (聯盟)";
ATLASLOOT_ZONE_HELLFIRE_W_PVP_HO = 	"Hellfire Fortifications (部落)";
ATLASLOOT_ZONE_ZANGAR = 			"贊加沼澤";
ATLASLOOT_ZONE_ZANGAR_W_PVP = 		"Twin Spire Ruins";
ATLASLOOT_ZONE_TEROKKAR = 			"泰羅卡森林";
ATLASLOOT_ZONE_TEROKKAR_W_PVP = 	"Spirit Towers";
ATLASLOOT_ZONE_NAGRAND = 			"納格蘭";
ATLASLOOT_ZONE_NAGRAND_W_PVP = 		"哈爾拉";
