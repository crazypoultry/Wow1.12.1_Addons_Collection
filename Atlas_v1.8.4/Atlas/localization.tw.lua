...
-- Last Update: 10/08/2006 - Arith
-- Revision History:
--    Translated based on 1.8.2
--]]
...
AtlasText = {
	...
	Naxxramas = {
		...
		_RED..INDENT..INDENT.."寇斯艾茲族長"; 			-- CONFIRMED - Thane Korth'azz
		_RED..INDENT..INDENT.."女公爵布勞繆克絲"; 	-- Lady Blaumeux
		_RED..INDENT..INDENT.."莫格萊尼公爵"; 	-- Highlord Mograine
		_RED..INDENT..INDENT.."札里克爵士"; 			-- CONFIRMED - Sir Zeliek
		PURP.."瘟疫區"; 						-- Necro Wing
		PURP..INDENT.."1) 瘟疫者諾斯";
		PURP..INDENT.."2) 骯髒者海根";
		PURP..INDENT.."3) 洛斯伯";
	...
	HCBloodFurnaces = {
		ZoneName = "HC: The Blood Furnaces";
		Location = "地域火堡壘";
	};
	HCShatteredHalls = {
