...
Atlas_MapTypes = {"Cartes d'instances", "Cartes de champs de bataille", "Cartes de trajets a\195\169riens", "Emplacements des instances", "Rencontres de Raid"};
...
AtlasText = {
	...
	HCShatteredHalls = {
		ZoneName = "Les Salles bris\195\169es";
		Location = "Citadelle des Flammes infernales";
	};
};
