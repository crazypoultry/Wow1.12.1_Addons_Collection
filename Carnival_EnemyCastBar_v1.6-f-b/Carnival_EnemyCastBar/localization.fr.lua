...
if ( GetLocale() == "frFR" ) then
	...
	Carnival_EnemyCastBar_Spells = {
		...
		["Bouclier dynamis\195\169"] = {t=20.0, c="gains"};
		["Lumi\195\168re \195\169clatante"] = {t=20.0, c="gains"};
	...
	Carnival_EnemyCastBar_Raids = {
		...
		-- Ahn'Qiraj
			...
			-- Twin Emperors
			["T\195\169l\195\169portation des jumeaux"] = {t=25.0, c="cooldown"};
			
		-- Zul'Gurrub
		
			-- Hakkar
			["Siphon de sang"] = {t=89.5, c="cooldown", m="Hakkar", u="true"};
		
		-- Molten Core
		
			-- Lucifron
			["Mal\195\169diction imminente"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
			["Mal\195\169diction de Lucifron"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
		
			-- Magmadar
			["Panique"] = {t=29.5, c="cooldown", m="Magmadar", u="true"};

			-- Gehennas
			["Mal\195\169diction de Gehennas"] = {t=29.5, c="cooldown", m="Gehennas", u="true"};

			-- Majordomo
			["Renvoi de la magie"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
			["Bouclier de d\195\169g\195\162ts"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
		...
		-- Blackwing Lair
			...
			["Frappe des ailes"] = {t=31.5, i=1.0, c="cooldown", u="true"}; 
			["Flamme d'ombre"] = {t=2.0, c="hostile"}; 
			
			-- Flamegor
			["Fr\195\169n\195\169sie"] = {t=10.0, c="cooldown"};
			
			-- Chromaggus
			["Br\195\187lure de givre"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Trou de temps"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Enflammer la chair"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Acide corrosif"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Incin\195\169rer"] = {t=59.5, i=2.0, c="cooldown", u="true"};
	...
	Carnival_EnemyCastBar_RAGNAROS_STARTING			= "^ET MAINTENANT,";
	Carnival_EnemyCastBar_RAGNAROS_KICKER			= "^GO\195\155TEZ";
	Carnival_EnemyCastBar_RAGNAROS_SONS	 			= "^VENEZ, MES SERVITEURS";
	...
	Carnival_EnemyCastBar_NEFARIAN_STARTING			= "Que les jeux commencent";
	Carnival_EnemyCastBar_NEFARIAN_LAND				= "Beau travail";
	Carnival_EnemyCastBar_NEFARIAN_SHAMAN_CALL		= "Chamans, montrez moi";
	Carnival_EnemyCastBar_NEFARIAN_DRUID_CALL		= "Les druides et leur stupides";
	Carnival_EnemyCastBar_NEFARIAN_WARLOCK_CALL		= "D\195\169monistes, vous ne devriez pas jouer";
	Carnival_EnemyCastBar_NEFARIAN_PRIEST_CALL		= "Pr\195\170tres ! Si vous continuez";
	Carnival_EnemyCastBar_NEFARIAN_HUNTER_CALL		= "Ah, les chasseurs et les stupides";
	Carnival_EnemyCastBar_NEFARIAN_WARRIOR_CALL		= "Guerriers, je sais que vous pouvez frapper plus fort";
	Carnival_EnemyCastBar_NEFARIAN_ROGUE_CALL		= "Voleurs, arr\195\170tez de vous cacher";
	Carnival_EnemyCastBar_NEFARIAN_PALADIN_CALL		= "Les paladins";
	Carnival_EnemyCastBar_NEFARIAN_MAGE_CALL		= "Les mages aussi";
