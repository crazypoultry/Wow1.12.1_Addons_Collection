...
if ( GetLocale() == "enUS" ) then
	...
	Carnival_EnemyCastBar_Raids = {
		...
		-- Ahn'Qiraj
			...
			-- Twin Emperors
			["Twin Teleport"] = {t=25.0, c="cooldown"};
	
		-- Zul'Gurrub
		
			-- Hakkar
			["Blood Siphon"] = {t=89.5, c="cooldown", m="Hakkar", u="true"};
		...
		-- Molten Core
			...
			-- Lucifron
			["Impending Doom"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
			["Lucifron's Curse"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
		
			-- Magmadar
			["Panic"] = {t=29.5, c="cooldown", m="Magmadar", u="true"};

			-- Gehennas
			["Gehennas' Curse"] = {t=29.5, c="cooldown", m="Gehennas", u="true"};

			-- Majordomo
			["Magic Reflection"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
			["Damage Shield"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
		...
		-- Blackwing Lair
			...
			["Wing Buffet"] = {t=31.5, i=1.0, c="cooldown", r="Onyxia", a=25.0, u="true"};
			...
			-- Chromaggus
			["Frost Burn"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Time Lapse"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Ignite Flesh"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Corrosive Acid"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Incinerate"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			...
			["Shadow Bolt Volley"] = {t=2.0, c="hostile"};
		...
		-- Outdoor
			...
			-- Azuregos
			["Manastorm"] = {t=10.0, c="hostile", u="true"};
