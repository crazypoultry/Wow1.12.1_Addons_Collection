...
if ( GetLocale() == "deDE" ) then
	...
	Carnival_EnemyCastBar_Spells = {
		...
		["Wille der Verlassenen"] = {t=5.0, c="gains"};
		["Wachsamkeit"] = {t=20.0, c="gains"};
		["Kriegsdonner"] = {t=1.5};
		["Steinform"] = {t=8.0};
		["Schattenschild"] = {t=1.5};
		["Erdsto\195\159"] = {t=20.0, c="gains"};
		...
		["Feuerzauberschutz"] = {t=30.0, c="gains"};
		["Frostzauberschutz"] = {t=30.0, c="gains"};
	...
	Carnival_EnemyCastBar_Raids = {
		...
		-- Ahn'Qiraj
			...
			-- Twin Emperors
			["Zwillingsteleport"] = {t=25.0, c="cooldown"};
			
		-- Zul'Gurrub
		
			-- Hakkar
			["Bluttrinker"] = {t=89.5, c="cooldown", m="Hakkar", u="true"};
		
		-- Molten Core
		
			-- Lucifron
			["Drohende Verdammnis"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
			["Lucifrons Fluch"] = {t=19.5, c="cooldown", m="Lucifron", u="true"};
		
			-- Magmadar
			["Panik"] = {t=29.5, c="cooldown", m="Magmadar", u="true"};

			-- Gehennas
			["Gehennas Fluch"] = {t=29.5, c="cooldown", m="Gehennas", u="true"};

			-- Majordomo
			["Magiereflexion"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
			["Schadenschild"] = {t=29.5, i=10.0, c="cooldown", m="Majordomo", u="true"};
		...
		-- Blackwing Lair
			...
			["Fl\195\188gelpuffer"] = {t=31.5, i=1.0, c="cooldown", u="true"};
			["Schattenflamme"] = {t=2.0, c="hostile"};
			
			-- Flamegor
			["Raserei"] = {t=10.0, c="cooldown"};
			
			-- Chromaggus
			["Frostbeulen"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Zeitraffer"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Fleisch entz\195\188nden"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["\195\164tzende S\195\164ure"] = {t=59.5, i=2.0, c="cooldown", u="true"};
			["Verbrennen"] = {t=59.5, i=2.0, c="cooldown", u="true"};
	...
	Carnival_EnemyCastBar_RAGNAROS_STARTING			= "NUN ZU EUCH, INSEKTEN";
	Carnival_EnemyCastBar_RAGNAROS_KICKER			= "SP\195\156RT DIE FLAMMEN";
	Carnival_EnemyCastBar_RAGNAROS_SONS	 			= "KOMMT HERBEI, MEINE DIENER";
	...
	Carnival_EnemyCastBar_SPELL_AFFLICTED			= "(.+) (.+) von (.+) betroffen.";
	Carnival_EnemyCastBar_SPELL_DAMAGE 				= "(.+) erleidet (.+) von (.+) (.+)";
