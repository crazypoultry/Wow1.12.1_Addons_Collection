aftt_color_chart_name =		"Blizzard Authentic";
aftt_color_chart_author =	"AquaFlare7 (AquaFlare7@comcast.net)";

--[[
	This color chart is used to simulate Blizzard's default tooltip appearance
--]]
...
aftt_color_name_hostile =		"CC4444";
aftt_color_name_neutral =		"FFCC00";
aftt_color_name_friendly =		"FFFFFF";
aftt_color_name_caution =		"FFFFFF";
aftt_color_name_pvp =			"008800";
aftt_color_name_tapped_by_me =		"CC4444";
