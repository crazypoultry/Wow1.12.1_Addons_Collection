aftt_color_chart_name =		"Simple Hostility";
aftt_color_chart_author =	"AquaFlare7 (AquaFlare7@comcast.net)";

--[[
	This color chart colors the name and background based on unit's hostility to you
--]]
...
aftt_color_name_friendly =		"0088FF";
aftt_color_name_caution =		"FF0000";
