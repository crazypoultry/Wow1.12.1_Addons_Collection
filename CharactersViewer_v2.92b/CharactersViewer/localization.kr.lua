...
--	CHARACTERSVIEWER_SAVEDON								= "Saved on: ";
	...
	-- unused: clear CHARACTERSVIEWER_USAGE_SUBCMD[2]                = " ì‚­ì œ <ì¸ìˆ˜1>: <ì¸ìˆ˜1> ì´ë¦„ì˜ ìºë¦­í„° í”„ë¡œíŒŒì¼ì„ ì‚­ì œí•©ë‹ˆë‹¤.";
	-- unused:  clearall CHARACTERSVIEWER_USAGE_SUBCMD[3]                = " ëª¨ë‘ì‚­ì œ : ëª¨ë“  ì„œë²„ì˜ ëª¨ë“  ìºë¦­í„° ìž¥ë¹„/ëŠ¥ë ¥ì¹˜ ì •ë³´ë¥¼ ì‚­ì œí•©ë‹ˆë‹¤.";
	CHARACTERSVIEWER_USAGE_SUBCMD[2]                = " ì´ì „ : " .. BINDING_NAME_CHARACTERSVIEWER_SWITCH_PREVIOUS;
	CHARACTERSVIEWER_USAGE_SUBCMD[3]                = " ë‹¤ìŒ : " .. BINDING_NAME_CHARACTERSVIEWER_SWITCH_NEXT;
	CHARACTERSVIEWER_USAGE_SUBCMD[4]                = " ë³€ê²½ <ì¸ìˆ˜1>: <ì¸ìˆ˜1> ì´ë¦„ì˜ ìºë¦­í„°ë¡œ ë³€ê²½í•©ë‹ˆë‹¤.";
	-- unused:  list CHARACTERSVIEWER_USAGE_SUBCMD[7]                = " ëª©ë¡ : í˜„ìž¬ ì„œë²„ì˜ ìºë¦­í„°ë“¤ì— ëŒ€í•œ ì—¬ëŸ¬ ì •ë³´ë¥¼ í‘œì‹œí•©ë‹ˆë‹¤.";
