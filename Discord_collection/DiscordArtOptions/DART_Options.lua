...
function DART_Add_Condition()
	...
	local index = table.getn(DART_Settings[DART_INDEX][DART_TEXTURE_INDEX].Conditions) + 1;
...
function DART_Select_Condition(condition, menucontrol)
	if (not condition) then
		...
		DART_CONDITION_BUFFER.overrides = "";
		for i,o in DART_Settings[DART_INDEX][DART_TEXTURE_INDEX].Conditions[condition].overrides do
			if (i == table.getn(DART_Settings[DART_INDEX][DART_TEXTURE_INDEX].Conditions[condition].overrides)) then
