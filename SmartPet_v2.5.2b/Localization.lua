...
-- The next 8 lines define the names of the pets abilities. The localization of these settings
...
SMARTPET_ACTIONS_NOCHASE	= "No Chase";
SMARTPET_SPELLS_SCATTERSHOT	= "Scatter Shot";
SMARTPET_SPELLS_FEEDPET		= "Feed Pet";
...
-- AutoFeed strings
SMARTPET_FOOD_SEARCHSTRING		= "Restores %d+ health.*Must remain seated while eating"; -- %d+ = healing points; .* = wildcard for any string
SMARTPET_FOOD_TYPESTRING		= "Consumable";
SMARTPET_FOOD_NOTAFOOD			= "%n is not a Food";	-- %n = item name
SMARTPET_FOOD_NOFOOD			= "No %f to feed %n"; -- %n = pet name, %f = food name
SMARTPET_FOOD_NOFOODINBAGS		= "No %f Left"; -- %f = food name
...
-- KeyBinding Labels
SMARTPET_BINDING_NAME_OPTIONSMENU	= "Options Menu";
...
SMARTPET_BINDING_NAME_SCATTERSHOT	= "Smart Scatter Shot";
SMARTPET_BINDING_NAME_THEBUTTON		= "Smart Pet Button";
SMARTPET_BINDING_NAME_FEEDPET		= "Feed Pet";
...
SMARTPET_PET_RECALL = "Recall %n";					-- %n = Pet name
SMARTPET_PET_DETAUNT = "Cower %n";					-- %n = Pet name
SMARTPET_PET_DEBUFF = "Breakable debuff found. %n is not attacking.";	-- %n = Pet name
...
SMARTPET_COMMANDS_AUTOCOWER_ENABLED	= "Your pet will now cower when low health";
SMARTPET_COMMANDS_AUTOCOWER_DISABLED	= "Your pet will no longer cower when low health";
...
SMARTPET_COMMANDS_DEBUFFCHECK_ENABLED	= "Your pet will check for breakable debuff spells on your target";
SMARTPET_COMMANDS_DEBUFFCHECK_DISABLED	= "Your pet will break any breakable debuff spells on your target";
SMARTPET_COMMANDS_ATTACKALERT_ENABLED	= "You will now give an alert on attack";
SMARTPET_COMMANDS_ATTACKALERT_DISABLED	= "You will no longer give an alert on attack";
SMARTPET_COMMANDS_ATTACKRUN_ENABLED	= "Your pet will now dash/dive on attack";
SMARTPET_COMMANDS_ATTACKRUN_DISABLED	= "Your pet will no longer dash/dive on attack";
SMARTPET_COMMANDS_AUTORECALL_ENABLED	= "Your pet will now retreat when low health";
SMARTPET_COMMANDS_AUTORECALL_DISABLED	= "Your pet will continue to attack when low health";
SMARTPET_COMMANDS_SPELLATTACK_ENABLED	= "You will now cast the spell on pet attack";
SMARTPET_COMMANDS_SPELLATTACK_DISABLED	= "You will no longer cast the spell on pet attack";
SMARTPET_COMMANDS_SCATTERSHOT_ENABLED	= "Your pet will change mood/command when you cast Scatter Shot";
SMARTPET_COMMANDS_SCATTERSHOT_DISABLED	= "Your pet will no longer change mood/command when you cast Scatter Shot";
SMARTPET_COMMANDS_AUTOFEED_ENABLED	= "Your pet will feed herself when she is unhappy";
SMARTPET_COMMANDS_AUTOFEED_DISABLED	= "Your pet will starve even if she is unhappy";
...
if ( GetLocale() == "deDE" ) then
	...
	-- Die nächsten 7 Zeilen legen die Namen der Tier-Aktionen fest. Diese *müssen* an die
	...
	SMARTPET_SPELLS_SCATTERSHOT	="Streuschuss";
...
-- The next 7 lines define the names of the pets abilities. The localization of these settings
-- into the clients language are a "must" to use the basic functions of SmartPet.
...
SMARTPET_SPELLS_SCATTERSHOT	= "Fl\195\168che de dispersion"
...
"Sheep",
"M\195\169tamorphose",
"Dompte une b\195\170te",
"Effrayer une b\195\170te",
"Sleep",
"Hibernation",
"Peur",
"Sarments",
...
"Asservir un d\195\169mon", 
"Effet Pi\195\168ge gelant", 
