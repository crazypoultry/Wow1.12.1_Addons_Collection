...
XPERL_CONF_XPERL_TOOLTIP_INFO_DESC	= "显示其他X-Perl使用者的信息，1.8.6及以上版本有效"
...
XPERL_CONF_CASTPARTY_FEATURES_DESC      = "启用 Cast Party，Click Heal，Genesis Clicks，Smart Heal，Just Click, Heart框体点击治疗特性"
XPERL_CONF_CASTPARTY_RAID		= "只对团队启用"
...
XPERL_CONF_PLAYER_HEALER_MODE		= "治疗者模式"
XPERL_CONF_PLAYER_HEALER_MODE_DESC	= "显示生命损失值而不是当前的生命值"
XPERL_CONF_PLAYER_HEALERMODE_DEFICIT	= "损失值"
XPERL_CONF_PLAYER_HEALERMODE_DEFICIT_DESC = "只显示损失的生命值"
XPERL_CONF_PLAYER_HEALERMODE_DEFICITMAX = "损失值/最大值"
XPERL_CONF_PLAYER_HEALERMODE_DEFICITMAX_DESC = "同时显示生命损失值和最大值"
...
XPERL_CONF_TARGET_BUFF_SIZE		= "目标Buff大小"
...
XPERL_CONF_TARGETTARGET_BUFFS		= "目标的目标Buffs"
...
XPERL_CONF_RAID_SORTBYCLASS_DESC        = "团队框体按职业排列\r|c0000FF30注意：你也可以从Blizzard团队界面将某一职业单独拖出来"
...
XPERL_CONF_COLOUR_APPLYTOGUILDLIST	= "应用于工会列表"
XPERL_CONF_COLOUR_APPLYTOGUILDLIST_DESC	= "姓名按职业着色应用于工会列表"
...
XPERL_CONF_COLOUR_CLASSIC_DESC		= "覆盖所选生命条颜色，使用Nymbia默认的绿/红色外观。但是并不同于绿色满血条和红色空血条的设置。"
...
XPERL_CONF_RAIDHELP_NOAUTO_DESC		= "不会自动创建战士目标列表"
XPERL_CONF_RAIDHELP_COLLECTOTHERS	= "显示其他目标"
XPERL_CONF_RAIDHELP_COLLECTOTHERS_DESC	= "启用对非坦克目标的扫描。注意：目标状态功能依赖于此"
