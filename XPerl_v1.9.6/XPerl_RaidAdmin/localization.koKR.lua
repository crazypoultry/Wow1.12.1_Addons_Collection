...
-- Raid Admin
	...
	-- Item Checker
	XPERL_CHECK_TITLE		= "X-Perl 아이템 체크"
	...
	XPERL_CHECK_REPORTPLAYER_DESC2	= "공대 채널에 수집된 플레이어 기록을 알립니다."

	XPERL_CHECK_BROKEN		= "고장"
	...
	XPERL_CHECK_REPORT_PNOTEQUIPED= "%s 갖추지 않음 %s 준비됨"
	XPERL_CHECK_REPORT_DROPDOWN	= "출력 채널"
	XPERL_CHECK_REPORT_DROPDOWN_DESC= "아이템 체크 사항을 출력한 채널 설정"
