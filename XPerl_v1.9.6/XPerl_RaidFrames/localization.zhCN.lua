...
if (GetLocale() == "zhCN") then
	...
	XPERL_RAID_TOOLTIP_BUFFEXPIRING	= "%s的%s在%s后过期"	-- Name, buff name, time to expire

	XPERL_RAID_DROPDOWN_SHOWPET	= "显示宠物"
	XPERL_RAID_DROPDOWN_SHOWOWNER	= "显示主人"

	XPERL_RAID_DROPDOWN_AUTOPROMOTE = "自动提升"
	XPERL_RAID_DROPDOWN_MAINTANKS	= "主坦克"
	XPERL_RAID_DROPDOWN_SETMT	= "设置 MT #%d"
	XPERL_RAID_DROPDOWN_REMOVEMT	= "移除 MT #%d"

	XPERL_RAID_RESSING		= "���ڸ���"
	XPERL_RAID_AFK			= "����"
	XPERL_RAID_DND			= "����"
	XPERL_RAID_AUTOPROMOTE		= "�Զ�����"
	XPERL_RAID_RESSER_AVAIL		= "����ս����"
