...
function TitanLocalizeDE() 
	...
	TITAN_PANEL_MENU_LOAD_SETTINGS = "Letzte Einstellungen (deiner Charaktere)";
	...
	TITAN_PANEL_MENU_DISBALE_FONT = "Schriftarten skalieren sperren";
	...
	TITAN_BAG_AMMO_POUCH_NAMES = {"Munition", "K\195\182cher", "Schulterg\195\188rtel", "Geschoss", "Laminablat", "Seele"};
	TITAN_BAG_SHARD_BAG_NAMES = {"Seelenbeutel", "Seelentasche", "Seele", "Kernteufelsstofftasche", "Teufelsstofftasche"};
	TITAN_BAG_PROF_BAG_NAMES = {"Verzauberter Magiestoffbeutel","Verzauberte Runenstofftasche","Cenarische Kr\195\164utertasche","Cenarischer Ranzen"};
	...
	TITAN_HONORPLUS_HINT = "Hint: Links-Klick f\195\188r Statistik.";
	TITAN_HONORPLUS_HINT_TOOLTIP = "(Links-Klick f\195\188r mehr)";
	...
	REPAIR_LOCALE["reminder"] = "Reparaturerinnerung";
