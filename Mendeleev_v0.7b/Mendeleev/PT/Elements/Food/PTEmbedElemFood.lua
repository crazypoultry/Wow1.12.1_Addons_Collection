...
local vmajor, vminor = "Food 1", tonumber(string.sub("$Revision: 666 $", 12, -3))
...
local t = {
	...
	foodalledible = {"food", "foodbonus", "foodstat", "foodperc", "foodpercbonus", "foodcomboperc", "foodcombohealth"},
	...
	foodbonus         = {"foodbreadbonus", "foodfishbonus", "foodmeatbonus", "foodmiscbonus", "foodcheesebonus"},
