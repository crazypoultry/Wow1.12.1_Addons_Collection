...
function Necrosis_Localization_Dialog_De()
	...
	NECROSIS_MESSAGE = {
		...
		["Interface"] = {
			...
			["CurseSelection"] = " selected as default. Cast it using the 'Cast Selected Curse' keybind.",
			["CurseAmplify"] = "<lightYellow>Amplify Curse will trigger whenever possible on cast.",
			["CursePetAttack"] = "<lightYellow>Casting the default curse will cause your pet to attack."
		},
		["Help"] = {
	...
	NECROSIS_CONFIGURATION = {
		...
		["ShadowVulnerabilityWarning"] = "Alert me when target has Shadow Vulnerability",
        ...
        -- added by Sylvette
		["StoneTrade"] = "Aktiviere Zauber um Gesundheitssteine handel in Combat"
	};
