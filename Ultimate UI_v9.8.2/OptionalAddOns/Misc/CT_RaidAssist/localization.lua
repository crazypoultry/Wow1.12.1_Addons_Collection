...
CT_RAMENU_MISCDESCRIPT = "Mana Conserve allows you to auto-cancel casting heals if the target has less than X deficit health when the spell is about to land |c00FFFFFFand you are in combat|r. Note that it doesn't work on people outside raid/party.";
