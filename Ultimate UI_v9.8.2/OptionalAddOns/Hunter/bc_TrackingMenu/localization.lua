...
if ( GetLocale() == "deDE" ) then
	...
	BINDING_NAME_BCTM_BINDING_TRACK_ELEMENTALS = "Elementargeister aufsp\195\188ren";
	...
	BINDING_NAME_BCTM_BINDING_TRACK_DRAGONKIN  = "Drakin aufsp\195\188ren";
	BINDING_NAME_BCTM_BINDING_SENSE_UNDEAD     = "Untote Sp\195\188ren";
	BINDING_NAME_BCTM_BINDING_SENSE_DEMONS     = "D\195\164monenersp\195\188rung";
	...
	BCTM_TEXT_TRACK_ELEMENTALS = "Elementargeister aufsp\195\188ren";
	...
	BCTM_TEXT_TRACK_DRAGONKIN  = "Drakin aufsp\195\188ren";

	BCTM_TEXT_SENSE_UNDEAD = "Untote Sp\195\188ren";
	BCTM_TEXT_SENSE_DEMONS = "D\195\164monenersp\195\188rung";
...
elseif ( GetLocale() == "frFR" ) then
	...
	BINDING_NAME_BCTM_BINDING_SENSE_UNDEAD     = "Sentir les morts-vivants";
	BINDING_NAME_BCTM_BINDING_SENSE_DEMONS     = "Sentir les d\195\169mons";
	...
	BCTM_TEXT_SENSE_UNDEAD = "Sentir les morts-vivants";
	BCTM_TEXT_SENSE_DEMONS = "Sentir les d\195\169mons";
