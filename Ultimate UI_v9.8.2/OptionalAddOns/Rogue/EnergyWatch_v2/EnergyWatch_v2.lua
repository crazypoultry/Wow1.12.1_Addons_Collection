ENERGYWATCH_VERSION = "EnergyWatch v2 1.3"
...
function EW_Enable(arg)
	...
	elseif( arg == 0) then
		...
		DEFAULT_CHAT_FRAME:AddMessage("EW_Enable(arg) returned invalid arg.");
	end
end

function EW_Lock(arg)
	if( arg == 1 ) then
...
function EW_RegisterUltimateUI()
	UltimateUI_RegisterConfiguration(
		"UUI_EW",
		"SECTION",
		"EnergyWatch",
		"Options to configure EnergyWatch."
	);
	UltimateUI_RegisterConfiguration(
		"UUI_EW_SEPARATOR",
		"SEPARATOR",
	...
	UltimateUI_RegisterConfiguration(
		...
		"CHECKBOX",
		"Unlock EW",
		"Check to allow dragging of EnergyWatch.",
		EW_Lock,
		1
	);
	UltimateUI_RegisterConfiguration(
...
EnergyWatch_EventHandler["VARIABLES_LOADED"] = function()
	EW_RegisterUltimateUI();
end
