...
function DAB_ConditionMenu_Update()
	...
	for i=1, numButtons do
		...
		if ( list[index] ) then
			...
			elseif (list[index].response == 100 or list[index].response == 101 or list[index].response == 108 or list[index].response == 109 or list[index].response == 114) then
...
function DAB_Select_Response(response, menucontrol)
	...
	elseif (response == 100 or response == 101 or response == 108 or response == 109 or response == 114) then
