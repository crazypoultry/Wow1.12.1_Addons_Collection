...
function CT_RABoss_newCT_RAMenu_OnShow()
	...
	CT_RAMenuFrameHomeButton8:SetScale(0.9111);
	CT_RAMenuFrameHomeButton8Description:SetText("Several features to aid you in killing raid bosses.");
	CT_RAMenuFrameHomeButton8Text:SetText("Boss Mods");
end
...
function CT_RAMenuBoss_Update()
	...
	-- Workaround to fix the issue with the scroll button not displaying OnShow
	CT_RAMenuFrameBossScrollFrameScrollBar:SetMinMaxValues(0, CT_RAMenuFrameBossScrollFrame:GetVerticalScrollRange());
end
