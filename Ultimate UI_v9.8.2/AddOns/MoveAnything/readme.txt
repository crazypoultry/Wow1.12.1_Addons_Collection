...
***NOTES on vJ1.0***
	...
	Notes: Apparently MoveAnything has been discontinued by Skrag
	(http://www.curse-gaming.com/mod.php?addid=601)
	
	This version of MoveAnything! is updated to get rid of the
	UNIT_NAME_UPDATE reliance.  It also now has a framefinder
	(ripped from Discord, hope you don't mind Loz!) and a nudge
	function (idea also from Discord, man Loz rocks :)
	
	Just open up the MoveAnything! panel (/move) or move a frame
	as you normally would (/move framename) to see the additions.
