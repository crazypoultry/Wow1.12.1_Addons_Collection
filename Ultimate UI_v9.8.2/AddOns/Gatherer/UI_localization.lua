--[[
	...
	Version: <%version%>
	Revision: $Id: UI_localization.lua,v 1.14 2005/09/13 11:00:27 islorgris Exp $
	...
	GathererHelp[4] ="|cffff7f3fWorld Map:|r\n\nThe World Map will display icons for all gathered items in the selected zone (400 max, according to selected filters, etc.).\n\nSince having a great number of items to display may cause lag while trying to access the map, by default the items are hidden and you have to click on the \"Show Item\" button at the lower-left corner of the World Map in order to display them (there is a toggle in the Filters option tab to display them all the time, enable this at your own risk).\n\nNB: this does no prevent the delay, it merely prevent it from occuring when the map is opened, it will still be there when you click the Show Items button.\n\nThe World Map also allows access to the Node Editor to do some basic manipulation on the Database, by alt-right clicking on a node.\n";
	...
	GathererDetails["releaseDate"] = "September 24, 2005";
...
if ( GetLocale() == "frFR" ) then
	...
	GathererHelp[4] ="|cffff7f3fCarte du Monde:|r\n\nLa carte du monde affiche les icones de tout ce qui a \195\169t\195\169 r\195\169colt\195\169 dans la zone s\195\169lectionn\195\169e (400 max, selon les filtres choisis, etc.).\n\nUn grand nombre d'objet \195\160 afficher pouvant causer un d\195\169lai de l'affichage de la carte, par d\195\169faut les objets sont cach\195\169s et il est n\195\169cessaire de cliquer sur le bouton \"Show Item\" situ\195\169 au coin inf\195\169rieur-gauche de la Carte du Monde pour les afficher (il y a une bascule dans l'onglet Filtres des options qui permet de les afficher en permanence, \195\160 n'activer qu'a vos risques).\n\nNB: ceci ne supprime pas le d\195\169lai, mais celui-ci ne se produira que lorsque le bouton Show Items sera cliqu\195\169.\n\nLa Carte du Monde permet aussi l'acc\195\169s \195\160 l'\195\169diteur de point pour effectuer des manipulations basiques sur la base de donn\195\169es, en faisant alt-clic droit sur un point.\n";
	...
	GathererDetails["releaseDate"] = "24 Septembre 2005";
