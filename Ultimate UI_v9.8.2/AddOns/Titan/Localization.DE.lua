...
function TitanLocalizeDE() 
	...
	TITAN_MOVABLE_TOOLTIP = "Ziehen um zu bewegen.";
	...
	TITAN_PANEL_MENU_DISABLE_PUSH = "Bildschirmjustierung deaktivieren (Grössenänderung)";
	...
	TITAN_PANEL_MENU_LOAD_SETTINGS = "Letzte Einstellungen (deiner Charaktäre)";
	...
	TITAN_PANEL_MENU_DISBALE_FONT = "verhindere grÃ¶ssenskalierung der Schrift";
	...
	TITAN_AMMO_THROWN_KEYWORD = "Wurf";
	...
	TITAN_BAG_AMMO_POUCH_NAMES = {"Munition", "Köcher", "Bandolier", "Shot", "Laminablat", "Soul"};
	...
	TITAN_BGMINIMAP_MENU_TEXT = "Battleground mini-Map"
	TITAN_BGMINIMAP_TOOLTIP = "Battleground Mini-Map umschalter"
	...
	TITAN_COORDS_TOOLTIP_HINTS_2 = "momentane Position in den Chat einzuf\195\188gen.";
	...
	TITAN_HONOR_BUTTON_LABEL_HK = "ES: ";
	TITAN_HONOR_BUTTON_LABEL_DK = "RM: ";
	TITAN_HONOR_TOOLTIP = "PvP Info zur Ehre";
	TITAN_HONOR_MENU_TEXT = "PvP Ehre";
	...
	TITAN_MEMORY_TOOLTIP_GC_INFO = "Abfallsammler Info: ";
	TITAN_MEMORY_TOOLTIP_GC_THRESHOLD = "Schwellwert Abfallsammler: ";
	TITAN_MEMORY_TOOLTIP_TIME_TO_GC = "Zeit bis n\195\164chste AS: "
...
--	TITAN_PERFORMANCE_MENU_SHOW_MEMORY = "Show Memory";
	...
	TITAN_RIDER_STATES = {'Zu Fuss', 'Beritten', 'Im Flug', 'Verwandelt'};
	TITAN_RIDER_ITEMS = 3;
	TITAN_RIDER_ITEM_NAMES = {nil,'Karotte am Stiel',nil};
	TITAN_RIDER_ITEM_DESCS = {'Mithrilsporen',nil,'Schwache Reittiertempo-Steigerung'};
	TITAN_RIDER_ITEM_SLOTS = {"FeetSlot","Trinket0Slot","HandsSlot"}

	TITAN_TRANS_TOOLTIP = "Transparenz der Leiste einstellen";
	TITAN_TRANS_TOOLTIP_VALUE = "Momentane Transparenz: ";
	TITAN_TRANS_TOOLTIP_HINT1 = "Hinweis: Links-Klick um die";
	TITAN_TRANS_TOOLTIP_HINT2 = "Transparenz der Leiste anzupassen.";
	TITAN_TRANS_CONTROL_TOOLTIP = "Transparenz der TitanLeiste: ";
	TITAN_TRANS_CONTROL_TITLE = "Transparenz";
	...
	TITAN_UISCALE_TOOLTIP_VALUE_UI = "Skalierung der Interfaces: ";
	TITAN_UISCALE_TOOLTIP_VALUE_PANEL = "Skalierung der Leiste: ";
	TITAN_UISCALE_TOOLTIP_VALUE_FONT = "Skalierung der Schrift: ";
	TITAN_UISCALE_TOOLTIP_HINT1 = "Hinweis: Links-Klick um die Skalierung";
	TITAN_UISCALE_TOOLTIP_HINT2 = "der Leiste oder der Spielinterfaces anzupassen.";
	TITAN_UISCALE_CONTROL_TOOLTIP_UI = "Skalierung der TitanLeiste: ";
	TITAN_UISCALE_CONTROL_TOOLTIP_PANEL = "Skalierung der Interfaces: ";
	TITAN_UISCALE_CONTROL_TOOLTIP_FONT = "Skalierung der Schrift: ";
	TITAN_UISCALE_CONTROL_TITLE_UI = "Interfaces";
	TITAN_UISCALE_CONTROL_TITLE_PANEL = "Panel";
	TITAN_UISCALE_CONTROL_TITLE_FONT = "Schrift";
	...
	TITAN_VOLUME_TOOLTIP = "Gesamtlautst\195\164rke einstellen";
	TITAN_VOLUME_TOOLTIP_VALUE = "Momentane Gesamtlautst\195\164rke: ";
	TITAN_VOLUME_TOOLTIP_HINT1 = "Hinweis: Links-Klick um die"
	TITAN_VOLUME_TOOLTIP_HINT2 = "Gesamtlautst\195\164rke anzupassen.";
	TITAN_VOLUME_CONTROL_TOOLTIP = "Gesamtlautst\195\164rke: ";
	TITAN_VOLUME_CONTROL_TITLE = "Lautst\195\164rke";
	TITAN_VOLUME_CONTROL_HIGH = "Laut";
	TITAN_VOLUME_CONTROL_LOW = "Leise";
	TITAN_VOLUME_MENU_TEXT = "Lautst\195\164rke";
	...
	TITAN_XP_TOOLTIP_LEVEL_TIME = "Spielzeit dieser Level: ";
	TITAN_XP_TOOLTIP_SESSION_TIME = "Spielzeit diese Sitzung: ";
	TITAN_XP_TOOLTIP_TOTAL_XP = "Gesamt XP dieser Level: ";
	TITAN_XP_TOOLTIP_LEVEL_XP = "XP erhalten dieser Level: ";
	TITAN_XP_TOOLTIP_TOLEVEL_XP = "XP ben\195\182tigt bis Aufstieg: ";
	TITAN_XP_TOOLTIP_SESSION_XP = "XP erhalten diese Sitzung: ";
	TITAN_XP_TOOLTIP_XPHR_LEVEL = "XP/Std dieser Level: ";
	TITAN_XP_TOOLTIP_XPHR_SESSION = "XP/Std diese Sitzung: ";
	...
	TITAN_XP_MENU_SHOW_XPHR_THIS_LEVEL = "Zeige XP/Std dieser Level";
	TITAN_XP_MENU_SHOW_XPHR_THIS_SESSION = "Zeige XP/Std diese Sitzung";
	...
	TITAN_REGEN_MENU_SHOW1 		= "Erscheinen"
	...
	TITAN_REGEN_TOOLTIP3 		= "Gut HP Regeneration: \t"..HIGHLIGHT_FONT_COLOR_CODE.."%d"..FONT_COLOR_CODE_CLOSE;
	TITAN_REGEN_TOOLTIP4 		= "Am schlechtesten HP Regeneration: \t"..HIGHLIGHT_FONT_COLOR_CODE.."%d"..FONT_COLOR_CODE_CLOSE;
	TITAN_REGEN_TOOLTIP5 		= "Gut MP Regeneration: \t"..HIGHLIGHT_FONT_COLOR_CODE.."%d"..FONT_COLOR_CODE_CLOSE;
	TITAN_REGEN_TOOLTIP6 		= "Am schlechtesten MP Regeneration: \t"..HIGHLIGHT_FONT_COLOR_CODE.."%d"..FONT_COLOR_CODE_CLOSE;
	...
	TITAN_ITEMBONUSES_BONUSSCANNER_MISSING = "BonusScanner AddOn wird benötigt";
	...
	TITAN_HONORPLUS_TOOLTIP_THISWEEK = "Diese Woche"
	TITAN_HONOR_MENU_TEXT = "Honor+";
	TITAN_HONORPLUS_MENU_CALCTODAY = "heutige Ehrenpunkte";
	TITAN_HONORPLUS_MENU_SCT = "Scrollende Kampftext Anzeige (SCT)";
	TITAN_HONORPLUS_MENU_OPIUM = "Opium Support";
	TITAN_HONORPLUS_MENU_SCOREBOARDCLASSCOLORSYMBOL = "Farbiges Klassensymbol auf Highscoreanzeige";
	TITAN_HONORPLUS_MENU_SCOREBOARDCLASSCOLORLIST = "Farbigen Klassennamen auf Highscoreanzeige";
	TITAN_HONORPLUS_MENU_SCOREBOARDKILLS = "Heutige Kills auf Highscoreanzeige anzeigen";
	TITAN_HONORPLUS_MENU_PRINTBONUS = "Ehre Info im Chat-Fenster anzeigen";
	...
	TITAN_HONORPLUS_PROGRESS = "Verarbeitung";
	TITAN_HONORPLUS_TODAYHONOR = "Heutige Ehre";
	TITAN_HONORPLUS_KILLS = "Kills";
	TITAN_HONORPLUS_DEATHS = "Tode";
	TITAN_HONORPLUS_TOTAL = "Total";
	TITAN_HONORPLUS_TOP15 = "Top 15";
	TITAN_HONORPLUS_PVPSTATS = "PvP Status";
	TITAN_HONORPLUS_NOKILLS = "keine Kills";
	TITAN_HONORPLUS_HINT = "Hint: links-klick für andere Statistik.";
	TITAN_HONORPLUS_HINT_TOOLTIP = "(Links-klick für mehr)";
	TITAN_HONORPLUS_TOOLTIP_TODAYSKILLS = "Heutige Kills.\nAb 4 Kills pro Spieler und Tag gibt es keine Ehrepunkte mehr.";
	...
	TITAN_HONORPLUS_AUTOJOINBG_DONE = "Battleground wird beigetreten, viel Glück!";
	...
	REPAIR_LOCALE["popup"] = "Zeige Reparieren-Pupup";
	REPAIR_LOCALE["repinventory"] = "Inventar auch reparieren";
