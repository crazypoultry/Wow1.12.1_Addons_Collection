...
function CT_RAMenu_OnLoad()
	...
	CT_RAMenuFrameHomeButton6Text:SetText("Debuff Curing");
	CT_RAMenuFrameHomeButton7Text:SetText("Option Sets");
	...
	CT_RAMenuFrameHomeButton6Description:SetText("Configure the debuff curing feature.");
	CT_RAMenuFrameHomeButton7Description:SetText("Save and load sets of options for easier setup.");
end
...
function CT_RAMenu_UpdateMenu()
	...
	CT_RATab_SetDropDownID( ( CT_RATab_DefaultLootMethod or 4 ) ); -- Default being Group Loot
...
function CT_RAMenu_General_ChannelOnShow()
	...
	elseif ( CT_RAMenu_Options["temp"]["SORTTYPE"] == "custom" ) then
		CT_RA_SetSortType("custom");
	elseif ( CT_RAMenu_Options["temp"]["SORTTYPE"] == "virtual" ) then
		CT_RA_SetSortType("virtual");
	else
		CT_RA_SetSortType("group");
	end
