...
ALLINONEINVENTORY_BAG_TITLE_SHORT 					= "Inventory";
...
table.insert(ALLINONEINVENTORY_CHAT_COMMAND_USAGE, "Usage: /allinoneinventory [xxx]");
...
table.insert(ALLINONEINVENTORY_CHAT_COMMAND_USAGE, " autobags - set if bags should automatically open when at AH/bank/mailbox/vendor/trade");
...
ALLINONEINVENTORY_CHAT_AUTOBAGS_ENABLED			  = "All In One Inventory will automatically open.";
ALLINONEINVENTORY_CHAT_AUTOBAGS_DISABLED			= "All In One Inventory will not automatically open.";
