...
IgnoreShare works the same way that IgnoreShare works. The only 
...
function IgnoreShare_Import()
	...
	for i, name in globalIgnores do
	...
	for i, name in IgnoreShare_RemovedIgnores[realmAndFaction] do
