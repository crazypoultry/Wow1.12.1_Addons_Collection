...
local function XPerl_Player_Pet_UpdateHealth()
	...
	XPerl_SetHealthBar(XPerl_Player_Pet_StatsFrame_HealthBar, pethealth, pethealthmax, XPerlConfig.HealerModePlayer, XPerlConfig.HealerModePlayerType)
...
local function XPerl_Player_Pet_UpdateManaType()
	XPerl_SetManaBarType("pet", XPerl_Player_Pet_StatsFrame_ManaBar)
end
...
local function XPerl_Player_Pet_Buff_UpdateAll ()
	if (UnitExists("pet")) then
		...
		XPerl_CheckDebuffs("pet", XPerl_Player_Pet.FlashFrames)
	end
end
...
-- Event Handler --
-------------------
function XPerl_Player_Pet_OnEvent()		-- TBC - function XPerl_Player_Pet_OnEvent(self, event)
