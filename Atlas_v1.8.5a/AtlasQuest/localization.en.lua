...
Inst20Quest3_HORDE_Note = "You find Doctor Theolen Krastinov, the Remains of Eva Sarkhoff and the Remains of Lucien Sarkhoff at "..YELLOW.."[9]"..WHITE.."."
...
Inst21Quest4_HORDE_Location = "Doan Karhan (Barrens; "..YELLOW.."49,57"..WHITE..")"
...
Inst8Quest1_Location = "Prospector Ironboot (Tanaris; "..YELLOW.."66,23"..WHITE..")"
Inst8Quest1_Note = "You find the tabels near "..YELLOW.."[4]"..WHITE.." and "..YELLOW.."[5]"..WHITE.."./nThe Rewards belongs to 'Confront Yeh'kinya'. You find Yeh'kinya near Ironboot."
...
Inst8Quest2_Location = "Kibler (Burning Steppes; "..YELLOW.."65,22"..WHITE..")"
Inst8Quest2_Note = "You find the Worg Cup at "..YELLOW.."[10]"..WHITE.."."
...
Inst8Quest3_Location = "Kibler (Burning Steppes; "..YELLOW.."65,22"..WHITE..")"
Inst8Quest3_Note = "You find the spidereggs near "..YELLOW.."[6]"..WHITE.."."
...
Inst8Quest4_Note = "Mother Smolderweb is at "..YELLOW.."[6]"..WHITE.."."
...
Inst8Quest5_Location = "Helendis (Burning Steppes; "..YELLOW.."5,47"..WHITE..")"
Inst8Quest5_Note = "You find Halycon at "..YELLOW.."[10]"..WHITE.."."
...
Inst8Quest6_Location = "Warosh (Blackrock Spire; "..YELLOW..""..WHITE..")"
Inst8Quest6_Note = "To get Warosh's Mojo you have to evoke/kill Urok Doomhowl"..YELLOW.."[8]"..WHITE..". For his Evocation you need a Speer and Highlord Omokks Head"..YELLOW.."[3]"..WHITE..". The Speer is near "..YELLOW.."[2]"..WHITE..". During the Evocation a few waves of ogres appear before Urok Doomhowl attacks you. Note: You can use the Speer during the fight to damage the ogres."
...
Inst8Quest7_Location = "Bijou (Blackrock Spire; "..YELLOW.."between [1] and [2]"..WHITE..")"
Inst8Quest7_Note = "You find Bijou's Belongings on the way to Mother Smolderweb("..YELLOW.."[10]"..WHITE..").\nYou can find Maxwell in the Burning Steppes("..YELLOW.."84,58"..WHITE..")."
...
Inst8Quest8_Location = "Marshal Maxwell (Burning Steppes; "..YELLOW.."84,58"..WHITE..")"
Inst8Quest8_Note = "You find War Master Voone at"..YELLOW.."[5]"..WHITE..", Highlord Omokk at "..YELLOW.."[3]"..WHITE.." and Overlord Wyrmthalak at "..YELLOW.."[11]"..WHITE.."."
...
Inst8Quest9_Location = "Vaelan (Blackrock Spire; "..YELLOW.."west of [1]"..WHITE..")"
Inst8Quest9_Note = "You get the Gemstone of Spirestone from Highlord Omokk("..YELLOW.."[3]"..WHITE.."), the Gemstone of Smolderthorn from War Master Voone("..YELLOW.."[5]"..WHITE.."), the Gemstone of Bloodaxe from Overlord Wyrmthalak("..YELLOW.."[11]"..WHITE..") and the Unadorned Seal of Ascension can dropp from near all enemys in LBRS.\nYou get the Key for UBRS if you complete this questline."
...
Inst8Quest10_Location = "General Drakkisath's Command ("..YELLOW.."Drop from Overlord Wyrmthalak"..WHITE..")"
Inst8Quest10_Note = "You get the commands from Overlord Wyrmthalak("..YELLOW.."[11]"..WHITE.."), Marshal Maxwell is in the Burning Steppes; "..YELLOW.."84,58"..WHITE.."."
Inst8Quest10_Prequest = "No"
Inst8Quest10_Folgequest = "Yes, General Drakkisath's Demise(UBRS)"


--Quest1 Horde

Inst8Quest1_HORDE = "1. The Final Tablets"
Inst8Quest1_HORDE_Attain = "56"
Inst8Quest1_HORDE_Level = "58"
Inst8Quest1_HORDE_Aim = "Bring the Fifth and Sixth Mosh'aru Tablets to Prospector Ironboot in Tanaris."
Inst8Quest1_HORDE_Location = "Prospector Ironboot (Tanaris; "..YELLOW.."66,23"..WHITE..")"
Inst8Quest1_HORDE_Note = "You find the tabels near "..YELLOW.."[4]"..WHITE.." and "..YELLOW.."[5]"..WHITE.."./nThe Rewards belongs to 'Confront Yeh'kinya'. You find Yeh'kinya near Ironboot."
Inst8Quest1_HORDE_Prequest = "Yes, The Lost Tablets of Mosh'aru"
Inst8Quest1_HORDE_Folgequest = "Yes, Confront Yeh'kinya"

--Quest2 Horde

Inst8Quest2_HORDE = "2. Kibler's Exotic Pets"
Inst8Quest2_HORDE_Attain = "55"
Inst8Quest2_HORDE_Level = "59"
Inst8Quest2_HORDE_Aim = "Travel to Blackrock Spire and find Bloodaxe Worg Pups. Use the cage to carry the ferocious little beasts. Bring back a Caged Worg Pup to Kibler."
Inst8Quest2_HORDE_Location = "Kibler (Burning Steppes; "..YELLOW.."65,22"..WHITE..")"
Inst8Quest2_HORDE_Note = "You find the Worg Cup at "..YELLOW.."[10]"..WHITE.."."
Inst8Quest2_HORDE_Prequest = "No"
Inst8Quest2_HORDE_Folgequest = "No"

--Quest3 Horde

Inst8Quest3_HORDE = "3. En-Ay-Es-Tee-Why"
Inst8Quest3_HORDE_Attain = "55"
Inst8Quest3_HORDE_Level = "59"
Inst8Quest3_HORDE_Aim = "Travel to Blackrock Spire and collect 15 Spire Spider Eggs for Kibler."
Inst8Quest3_HORDE_Location = "Kibler (Burning Steppes; "..YELLOW.."65,22"..WHITE..")"
Inst8Quest3_HORDE_Note = "You find the spidereggs near "..YELLOW.."[6]"..WHITE.."."
Inst8Quest3_HORDE_Prequest = "No"
Inst8Quest3_HORDE_Folgequest = "No"

--Quest4 Horde

Inst8Quest4_HORDE = "4. Mother's Milk"
Inst8Quest4_HORDE_Attain = "?"
Inst8Quest4_HORDE_Level = "60"
Inst8Quest4_HORDE_Aim = "In the heart of Blackrock Spire you will find Mother Smolderweb. Engage her and get her to poison you. Chances are good that you will have to kill her as well. Return to Ragged John when you are poisoned so that he can 'milk' you."
Inst8Quest4_HORDE_Location = "Ragged John (Burning Steppes; "..YELLOW.."65,23"..WHITE..")"
Inst8Quest4_HORDE_Note = "Mother Smolderweb is at "..YELLOW.."[6]"..WHITE.."."
Inst8Quest4_HORDE_Prequest = "No"
Inst8Quest4_HORDE_Folgequest = "No"
...
Inst8Quest5_HORDE_Note = "You find Halycon at "..YELLOW.."[10]"..WHITE.."."
Inst8Quest5_HORDE_Prequest = "No"
Inst8Quest5_HORDE_Folgequest = "No"

--Quest6 Horde

Inst8Quest6_HORDE = "6. Urok Doomhowl"
Inst8Quest6_HORDE_Attain = "?"
Inst8Quest6_HORDE_Level = "59"
Inst8Quest6_HORDE_Aim = "Read Warosh's Scroll. Bring Warosh's Mojo to Warosh."
Inst8Quest6_HORDE_Location = "Warosh (Blackrock Spire; "..YELLOW..""..WHITE..")"
Inst8Quest6_HORDE_Note = "To get Warosh's Mojo you have to evoke/kill Urok Doomhowl"..YELLOW.."[8]"..WHITE..". For his Evocation you need a Speer and Highlord Omokks Head"..YELLOW.."[3]"..WHITE..". The Speer is near "..YELLOW.."[2]"..WHITE..". During the Evocation a few waves of ogres appear before Urok Doomhowl attacks you. Note: You can use the Speer during the fight to damage the ogres."
Inst8Quest6_HORDE_Prequest = "No"
Inst8Quest6_HORDE_Folgequest = "No"
...
Inst8Quest7_HORDE_Note = "You find Bijou between "..YELLOW.."[1] and [2]"..WHITE.."."
...
Inst8Quest8_HORDE_Location = "Bijou (Blackrock Spire; "..YELLOW.."[]"..WHITE..")"
Inst8Quest8_HORDE_Note = "You find Bijou's Belongings on the way to Mother Smolderweb("..YELLOW.."[6]"..WHITE..").\nThe Rewards belongs to 'Bijou's Reconnaissance Report'."
Inst8Quest8_HORDE_Prequest = "Yes, Operative Bijou"
Inst8Quest8_HORDE_Folgequest = "Yes, Bijou's Reconnaissance Report"

--Quest9 Horde

Inst8Quest9_HORDE = "9. Seal of Ascension"
Inst8Quest9_HORDE_Attain = "57"
Inst8Quest9_HORDE_Level = "60"
Inst8Quest9_HORDE_Aim = "Find the three gemstones of command: The Gemstone of Smolderthorn, Gemstone of Spirestone, and Gemstone of Bloodaxe. Return them, along with the Unadorned Seal of Ascension, to Vaelan."
Inst8Quest9_HORDE_Location = "Vaelan (Blackrock Spire; "..YELLOW.."[]"..WHITE..")"
Inst8Quest9_HORDE_Note = "You get the Gemstone of Spirestone from Highlord Omokk("..YELLOW.."[3]"..WHITE.."), the Gemstone of Smolderthorn from War Master Voone("..YELLOW.."[5]"..WHITE.."), the Gemstone of Bloodaxe from Overlord Wyrmthalak("..YELLOW.."[11]"..WHITE..") and the Unadorned Seal of Ascension can dropp from near all enemys in LBRS.\nYou get the Key for UBRS if you complete this questline."
Inst8Quest9_HORDE_Prequest = "No"
Inst8Quest9_HORDE_Folgequest = "Yes, Seal of Ascension"
...
Inst8Quest10_HORDE_Note = "Qnyxia PreQuest!\nYou find Highlord Omokk at "..YELLOW.."[3]"..WHITE..", War Master Voone at "..YELLOW.."[5]"..WHITE.." and Overlord Wyrmthalak at "..YELLOW.."[11]"..WHITE..". The Blackrock Documents could appear next to one of this 3 bosses."
Inst8Quest10_HORDE_Prequest = "No"
Inst8Quest10_HORDE_Folgequest = "Yes, Eitrigg's Wisdom -> For the Horde!(UBRS)"
...
Inst9Quest1_Note = "You find Awbee in the room after the Arena"..YELLOW.."[6]"..WHITE..". She stands on a jutty.\nHaleh is in winterspring("..YELLOW.."54,51"..WHITE.."). Use the portal-sign in the end of the cage to get to her."
...
Inst9Quest2_Note = "Finkle Einhorn spawns sometimes after killing the beast.\You find Malyfous in Winterspring(Everlook; "..YELLOW.."61,38"..WHITE..")."
...
Inst9Quest3_Location = "Tinkee Steamboil (Burning Steppes; "..YELLOW.."65,24"..WHITE..")"
Inst9Quest3_Note = "Questline! You find the eggs in the room of Father Flame("..YELLOW.."[2]"..WHITE..")."
Inst9Quest3_Prequest = "Ja, Broodling Essence -> Tinkee Steamboil"
Inst9Quest3_Folgequest = "Ja, Leonid Barthalomew -> Dawn's Gambit(Scholo)"
...
Inst9Quest4_Note = "You can find Emberseer at "..YELLOW.."[1]"..WHITE.."."
...
Inst9Quest5_Location = "Marshal Maxwell (Burning Steppes; "..YELLOW.."82,68"..WHITE..")"
Inst9Quest5_Note = "You find General Drakkisath at "..YELLOW.."[8]"..WHITE.."."
Inst9Quest5_Prequest = "Yes, General Drakkisath's Command(LBRS)"
...
Inst9Quest6_Location = "Mayara Brightwing (Burning Steppes; "..YELLOW.."84,69"..WHITE..")"
Inst9Quest6_Note = "You get the prequest from Count Remington Ridgewell (Stormwind; "..YELLOW.."74,30"..WHITE..").\nYou find the Doomrigger's Clasp in the Father Flamme room "..YELLOW.."[2]"..WHITE.."."
...
Inst9Quest7_Note = "Last part of the Onyxia quest chain for the alliance.\nYou find General Drakkisath at "..YELLOW.."[8]"..WHITE.."."
...
Inst9Quest8_Location = "Blackhand's Command (Drop by Scarshield Quartermaster; "..YELLOW.."Blackrock Spire"..WHITE..")"
Inst9Quest8_Note = "BWL Prequest!\nYou find the Quartermaster, if you turn right before the entrance of LBRS/UBRS.\nGeneral Drakkisath is at "..YELLOW.."[8]"..WHITE..". The brand is behind him."
Inst9Quest8_Prequest = "No"
Inst9Quest8_Folgequest = "No"

--Quest1 Horde

Inst9Quest1_HORDE = "1. The Matron Protectorate"
Inst9Quest1_HORDE_Attain = "57"
Inst9Quest1_HORDE_Level = "60"
Inst9Quest1_HORDE_Aim = "Travel to Winterspring and find Haleh. Give her Awbee's scale."
Inst9Quest1_HORDE_Location = "Awbee (Blackrock Spire"..YELLOW.."[6]"..WHITE..")"
Inst9Quest1_HORDE_Note = "You find Awbee in the room after the Arena"..YELLOW.."[6]"..WHITE..". She stands on a jutty.\nHaleh is in winterspring("..YELLOW.."54,51"..WHITE.."). Use the portal-sign in the end of the cage to get to her."
Inst9Quest1_HORDE_Prequest = "No"
Inst9Quest1_HORDE_Folgequest = "Yes, Wrath of the Blue Flight"

--Quest2 Horde

Inst9Quest2_HORDE = "2. Finkle Einhorn, At Your Service!"
Inst9Quest2_HORDE_Attain = "?"
Inst9Quest2_HORDE_Level = "60"
Inst9Quest2_HORDE_Aim = "Talk to Malyfous Darkhammer in Everlook."
Inst9Quest2_HORDE_Location = "Finkle Einhorn (Blackrock Spire"..YELLOW.."[7]"..WHITE..")"
Inst9Quest2_HORDE_Note = "Finkle Einhorn spawns sometimes after killing the beast.\You find Malyfous in Winterspring(Everlook; "..YELLOW.."61,38"..WHITE..")."
Inst9Quest2_HORDE_Prequest = "No"
Inst9Quest2_HORDE_Folgequest = "Yes, Leggings of Arcana, Cap of the Scarlet Savant, Breastplate of Bloodthirst"

--Quest3 Horde

Inst9Quest3_HORDE = "3. Egg Freezing"
Inst9Quest3_HORDE_Attain = "?"
Inst9Quest3_HORDE_Level = "60"
Inst9Quest3_HORDE_Aim = "Use the Eggscilloscope Prototype on an egg in the Rookery."
Inst9Quest3_HORDE_Location = "Tinkee Steamboil (Burning Steppes; "..YELLOW.."65,24"..WHITE..")"
Inst9Quest3_HORDE_Note = "Questline! You find the eggs in the room of Father Flame("..YELLOW.."[2]"..WHITE..")."
Inst9Quest3_HORDE_Prequest = "Ja, Broodling Essence -> Tinkee Steamboil"
Inst9Quest3_HORDE_Folgequest = "Ja, Leonid Barthalomew -> Dawn's Gambit(Scholo)"

--Quest4 Horde

Inst9Quest4_HORDE = "4. Eye of the Emberseer"
Inst9Quest4_HORDE_Attain = "60"
Inst9Quest4_HORDE_Level = "60"
Inst9Quest4_HORDE_Aim = "Bring the Eye of the Emberseer to Duke Hydraxis in Azshara."
Inst9Quest4_HORDE_Location = "Duke Hydraxis (Azshara; "..YELLOW.."79,73"..WHITE..")"
Inst9Quest4_HORDE_Note = "You can find Emberseer at "..YELLOW.."[1]"..WHITE.."."
Inst9Quest4_HORDE_Prequest = "Yes, Poisoned Water"
Inst9Quest4_HORDE_Folgequest = "Yes, The Molten Core"
...
Inst9Quest5_HORDE_Location = "Vivian Lagrave (Badlands - Kargath; "..YELLOW.."02,47"..WHITE..")"
Inst9Quest5_HORDE_Note = "You get the prequest from Apothecary Zinge in Undercity ("..YELLOW.."50,68"..WHITE..").\nThe Darkstone Tablet is in the Father Flame room("..YELLOW.."[2]"..WHITE..")."
...
Inst9Quest6_HORDE_Note = "Onyxia Prequest!\nYou find Rend Blackhand at "..YELLOW.."[5]"..WHITE.."."
...
Inst9Quest7_HORDE_Note = "Dragokin drop the eyes."
Inst9Quest7_HORDE_Prequest = "Yes, Finding Rexxar -> The Testament of Rexxar"
...
Inst9Quest8_HORDE_Location = "Rexxar (Feralas - Desolace - Stonetalon Mountains; "..YELLOW..""..WHITE..")"
Inst9Quest8_HORDE_Note = "Last part of the Onyxia prequest\nYou find General Drakkisath at "..YELLOW.."[8]"..WHITE.."."
...
Inst9Quest9_HORDE_Aim = "The letter indicates that General Drakkisath guards the brand. Perhaps you should investigate."
Inst9Quest9_HORDE_Location = "Blackhand's Command (Drop by Scarshield Quartermaster; "..YELLOW.."Blackrock Spire"..WHITE..")"
Inst9Quest9_HORDE_Note = "BWL Prequest!\nYou find the Quartermaster, if you turn right before the entrance of LBRS/UBRS.\nGeneral Drakkisath is at "..YELLOW.."[8]"..WHITE..". The brand is behind him."
Inst9Quest9_HORDE_Prequest = "No"
...
Inst10Quest1_Note = "You find Pusslin in the "..YELLOW.."East"..WHITE.." part of Dire Maul.\nHe fleews, if you talk to him("..YELLOW.."[1]"..WHITE.."), but stop and fight at ("..YELLOW.."[2]"..WHITE.."). He dropps the key for Dire Maul Nord and West."
...
Inst10Quest2_Note = "You find Lethtendris in the "..YELLOW.."East"..WHITE.." part of Dire Maul at "..YELLOW.."[3]"..WHITE.."."
Inst10Quest2_Prequest = ""
Inst10Quest2_Folgequest = ""

--Quest3 Horde

Inst10Quest3 = "3. A Broken Trap"
Inst10Quest3_Attain = "?"
Inst10Quest3_Level = "60"
Inst10Quest3_Aim = "-"
Inst10Quest3_Location = "A Broken Trap (Dire Maul; "..YELLOW.."North"..WHITE..")"
Inst10Quest3_Note = "Repeatable!\nTo repair the trap you have to use a [Thorium Widget] and a [Frost Oil]."
Inst10Quest3_Prequest = ""
Inst10Quest3_Folgequest = ""

--Quest4 Horde

Inst10Quest4 = "4. The Gordok Ogre Suit"
Inst10Quest4_Attain = "?"
Inst10Quest4_Level = "60"
Inst10Quest4_Aim = "Bring 4 Bolts of Runecloth, 8 Rugged Leather, 2 Rune Threads, and Ogre Tannin to Knot Thimblejack. He is currently chained inside the Gordok wing of Dire Maul."
Inst10Quest4_Location = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..WHITE..")"
Inst10Quest4_Note = "Repeatabel!\nYou get the Ogre Tannin near "..YELLOW.."[4] (above)"..WHITE.."."
Inst10Quest4_Prequest = ""
Inst10Quest4_Folgequest = ""

--Quest5 Horde

Inst10Quest5 = "5. Free Knot!"
Inst10Quest5_Attain = "?"
Inst10Quest5_Level = "60"
Inst10Quest5_Aim = "Collect a Gordok Shackle Key for Knot Thimblejack."
Inst10Quest5_Location = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..WHITE..")"
Inst10Quest5_Note = "Repeatable!\nEvery warden can drop the key."
Inst10Quest5_Prequest = ""
Inst10Quest5_Folgequest = ""
...
Inst10Quest6_Aim = "Find the Felvine in Dire Maul and acquire a shard from it. Chances are you'll only be able to procure one with the demise of Alzzin the Wildshaper. Use the Reliquary of Purity to securely seal the shard inside, and return it to Rabine Saturna in Nighthaven, Moonglade."
Inst10Quest6_Location = "Rabine Saturna (Moonglade ; "..YELLOW.."51,44"..WHITE..")"
Inst10Quest6_Note = "You find Alliz the Wildshaper in the "..YELLOW.."East"..WHITE.." part of Dire Maul("..YELLOW.."[5]"..WHITE..").\nYou get the prequest from Rabine Saturna, too. The relict is in Silithius at 62,54."
Inst10Quest6_Prequest = "A Reliquary of Purity"
Inst10Quest6_Folgequest = ""

--Quest7 Horde

Inst10Quest7 = "7. Elven Legends"
Inst10Quest7_Attain = "54"
Inst10Quest7_Level = "60"
Inst10Quest7_Aim = "Search Dire Maul for Kariel Winthalus. Report back to Scholar Runethorn at Feathermoon with whatever information that you may find."
Inst10Quest7_Location = "Scholar Runethorn (Feralas; "..YELLOW.."31,43"..WHITE..")" --ALLYS
Inst10Quest7_Note = "You find Kariel Winthalus in the "..YELLOW.."libary (West)"..WHITE..""
Inst10Quest7_Prequest = ""
Inst10Quest7_Folgequest = ""

--Quest8 Horde

Inst10Quest8 = "8. The Madness Within"
Inst10Quest8_Attain = "?"
Inst10Quest8_Level = "60"
Inst10Quest8_Aim = "You must destroy the guardians surrounding the 5 Pylons that power the Prison of Immol'thar. Once the Pylons have powered down, the force field surrounding Immol'thar will have dissipated.\nEnter the Prison of Immol'thar and eradicate the foul demon that stands at its heart. Finally, confront Prince Tortheldrin in Athenaeum."
Inst10Quest8_Location = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1] (above)"..WHITE..")"
Inst10Quest8_Note = "The Pylone are signed as "..BLUE.."[B]"..WHITE..". Immol'thar is at "..YELLOW.."[6]"..WHITE..", Prince Tortheldrin at "..YELLOW.."[7]"..WHITE.."."
Inst10Quest8_Prequest = ""
Inst10Quest8_Folgequest = "The Treasure of the Shen'dralar"

--Quest9 Horde

Inst10Quest9 = "9. The Treasure of the Shen'dralar"
Inst10Quest9_Attain = "?"
Inst10Quest9_Level = "60"
Inst10Quest9_Aim = "Return to the Athenaeum and find the Treasure of the Shen'dralar. Claim your reward!"
Inst10Quest9_Location = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1]"..WHITE..")"
Inst10Quest9_Note = "You can find the Treasure under the stairs "..YELLOW.."[7]"..WHITE.."."
Inst10Quest9_Prequest = "The Madness Within"
Inst10Quest9_Folgequest = ""

--Quest10 Horde

Inst10Quest10 = "10. Unfinished Gordok Business"
Inst10Quest10_Attain = "?"
Inst10Quest10_Level = "60"
Inst10Quest10_Aim = "Find the Gauntlet of Gordok Might and return it to Captain Kromcrush in Dire Maul.\nAccording to Kromcrush, the 'old timey story' says that Tortheldrin - a 'creepy' elf who called himself a prince - stole it from one of the Gordok kings."
Inst10Quest10_Location = "Captain Kromcrush (Dire Maul; "..YELLOW.."North, [5]"..WHITE..")"
Inst10Quest10_Note = "You find the Prince in the "..YELLOW.."West"..WHITE.." part of Dire Maul("..YELLOW.."[7]"..WHITE.."). The Gautlet are near him in a chest.\nYou can only get this quest after a Tribut run!"
Inst10Quest10_Prequest = ""
Inst10Quest10_Folgequest = ""



--Quest1 Horde

Inst10Quest1_HORDE = "1. Pusillin and the Elder Azj'Tordin"
Inst10Quest1_HORDE_Attain = "?"
Inst10Quest1_HORDE_Level = "58"
Inst10Quest1_HORDE_Aim = "Travel to Dire Maul and locate the Imp, Pusillin. Convince Pusillin to give you Azj'Tordin's Book of Incantations through any means necessary.\nReturn to Azj'Tordin at the Lariss Pavilion in Feralas should you recover the Book of Incantations."
Inst10Quest1_HORDE_Location = "Azj'Tordin (Feralas; "..YELLOW.."76,37"..WHITE..")"
Inst10Quest1_HORDE_Note = "You find Pusslin in the "..YELLOW.."East"..WHITE.." part of Dire Maul.\nHe fleews, if you talk to him("..YELLOW.."[1]"..WHITE.."), but stop and fight at ("..YELLOW.."[2]"..WHITE.."). He dropps the key for Dire Maul Nord and West, too."
...
Inst10Quest2_HORDE_Note = "You find Lethtendris in the "..YELLOW.."East"..WHITE.." part of Dire Maul at "..YELLOW.."[3]"..WHITE.."."
Inst10Quest2_HORDE_Prequest = ""
Inst10Quest2_HORDE_Folgequest = ""

--Quest3 Horde

Inst10Quest3_HORDE = "3. A Broken Trap"
Inst10Quest3_HORDE_Attain = "?"
Inst10Quest3_HORDE_Level = "60"
Inst10Quest3_HORDE_Aim = "-"
Inst10Quest3_HORDE_Location = "A Broken Trap (Dire Maul; "..YELLOW.."North"..WHITE..")"
Inst10Quest3_HORDE_Note = "Repeatable!\nTo repair the trap you have to use a [Thorium Widget] and a [Frost Oil]."
Inst10Quest3_HORDE_Prequest = ""
Inst10Quest3_HORDE_Folgequest = ""

--Quest4 Horde

Inst10Quest4_HORDE = "4. The Gordok Ogre Suit"
Inst10Quest4_HORDE_Attain = "?"
Inst10Quest4_HORDE_Level = "60"
Inst10Quest4_HORDE_Aim = "Bring 4 Bolts of Runecloth, 8 Rugged Leather, 2 Rune Threads, and Ogre Tannin to Knot Thimblejack. He is currently chained inside the Gordok wing of Dire Maul."
Inst10Quest4_HORDE_Location = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..WHITE..")"
Inst10Quest4_HORDE_Note = "Repeatabel!\nYou get the Ogre Tannin near "..YELLOW.."[4] (above)"..WHITE.."."
Inst10Quest4_HORDE_Prequest = ""
Inst10Quest4_HORDE_Folgequest = ""

--Quest5 Horde

Inst10Quest5_HORDE = "5. Free Knot!"
Inst10Quest5_HORDE_Attain = "?"
Inst10Quest5_HORDE_Level = "60"
Inst10Quest5_HORDE_Aim = "Collect a Gordok Shackle Key for Knot Thimblejack."
Inst10Quest5_HORDE_Location = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..WHITE..")"
Inst10Quest5_HORDE_Note = "Repeatable!\nEvery warden can drop the key."
Inst10Quest5_HORDE_Prequest = ""
Inst10Quest5_HORDE_Folgequest = ""

--Quest6 Horde

Inst10Quest6_HORDE = "6. Shards of the Felvine"
Inst10Quest6_HORDE_Attain = "?"
Inst10Quest6_HORDE_Level = "60"
Inst10Quest6_HORDE_Aim = "Find the Felvine in Dire Maul and acquire a shard from it. Chances are you'll only be able to procure one with the demise of Alzzin the Wildshaper. Use the Reliquary of Purity to securely seal the shard inside, and return it to Rabine Saturna in Nighthaven, Moonglade."
Inst10Quest6_HORDE_Location = "Rabine Saturna (Moonglade ; "..YELLOW.."51,44"..WHITE..")"
Inst10Quest6_HORDE_Note = "You find Alliz the Wildshaper in the  "..YELLOW.."East"..WHITE.." part of Dire Maul("..YELLOW.."[5]"..WHITE..").\nYou get the prequest from Rabine Saturna, too. The relict is in Silithius at 62,54."
Inst10Quest6_HORDE_Prequest = "A Reliquary of Purity"
Inst10Quest6_HORDE_Folgequest = ""

--Quest7 Horde

Inst10Quest7_HORDE = "7. Elven Legends"
Inst10Quest7_HORDE_Attain = "54"
Inst10Quest7_HORDE_Level = "60"
Inst10Quest7_HORDE_Aim = "Search Dire Maul for Kariel Winthalus. Report back to Sage Korolusk at Camp Mojache with whatever information that you may find."
Inst10Quest7_HORDE_Location = "Sage Korolusk (Feralas; "..YELLOW.."74,43"..WHITE..")" --ALLYS
Inst10Quest7_HORDE_Note = "You find Kariel Winthalus in the "..YELLOW.."libary (West)"..WHITE..""
Inst10Quest7_HORDE_Prequest = ""
Inst10Quest7_HORDE_Folgequest = ""

--Quest8 Horde

Inst10Quest8_HORDE = "8. The Madness Within"
Inst10Quest8_HORDE_Attain = "?"
Inst10Quest8_HORDE_Level = "60"
Inst10Quest8_HORDE_Aim = "You must destroy the guardians surrounding the 5 Pylons that power the Prison of Immol'thar. Once the Pylons have powered down, the force field surrounding Immol'thar will have dissipated.\nEnter the Prison of Immol'thar and eradicate the foul demon that stands at its heart. Finally, confront Prince Tortheldrin in Athenaeum."
Inst10Quest8_HORDE_Location = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1] (above)"..WHITE..")"
Inst10Quest8_HORDE_Note = "The Pylone are signed as "..BLUE.."[B]"..WHITE..". Immol'thar is at "..YELLOW.."[6]"..WHITE..", Prince Tortheldrin at "..YELLOW.."[7]"..WHITE.."."
Inst10Quest8_HORDE_Prequest = ""
Inst10Quest8_HORDE_Folgequest = "The Treasure of the Shen'dralar"

--Quest9 Horde

Inst10Quest9_HORDE = "9. The Treasure of the Shen'dralar"
Inst10Quest9_HORDE_Attain = "?"
Inst10Quest9_HORDE_Level = "60"
Inst10Quest9_HORDE_Aim = "Return to the Athenaeum and find the Treasure of the Shen'dralar. Claim your reward!"
Inst10Quest9_HORDE_Location = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1]"..WHITE..")"
Inst10Quest9_HORDE_Note = "You can find the Treasure under the stairs "..YELLOW.."[7]"..WHITE.."."
Inst10Quest9_HORDE_Prequest = "The Madness Within"
Inst10Quest9_HORDE_Folgequest = ""

--Quest10 Horde

Inst10Quest10_HORDE = "10. Unfinished Gordok Business"
Inst10Quest10_HORDE_Attain = "?"
Inst10Quest10_HORDE_Level = "60"
Inst10Quest10_HORDE_Aim = "Find the Gauntlet of Gordok Might and return it to Captain Kromcrush in Dire Maul.\nAccording to Kromcrush, the 'old timey story' says that Tortheldrin - a 'creepy' elf who called himself a prince - stole it from one of the Gordok kings."
Inst10Quest10_HORDE_Location = "Captain Kromcrush (Dire Maul; "..YELLOW.."North, [5]"..WHITE..")"
Inst10Quest10_HORDE_Note = "You find the Prince in the "..YELLOW.."West"..WHITE.." part of Dire Maul("..YELLOW.."[7]"..WHITE.."). The Gautlet are near him in a chest.\nYou can only get this quest after a Tribut run!"
Inst10Quest10_HORDE_Prequest = ""
Inst10Quest10_HORDE_Folgequest = ""
...
Inst22Quest8_Note = "To start the quest you have to give Aurius the [The Medallion of Faith]. You get the Medallion from a chest(Malor's Strongbox) near in the first chamber of the bastion(before the ways split). After giving Aurius the Medallion he supports your group in the fight against the Baron("..YELLOW.."[15]"..WHITE.."). After killing the Baron you have to talk to Aurius again to get the Rewards."
