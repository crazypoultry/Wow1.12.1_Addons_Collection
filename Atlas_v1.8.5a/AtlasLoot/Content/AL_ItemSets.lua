AtlasLootSetItems = {
   ...
   T1Paladin = {
    ...
    BoEWorldEpics3040 = {
        ...
        { 869, "inv_sword_25", "=q4=Dazzling Longsword", "=ds=#h1# #w10#" };
        ...
        { 868, "inv_mace_13", "=q4=Ardent Custodian", "=ds=#h1# #w6#" };
	...
	BoEWorldEpics4050 = {
		...
		{ 809, "inv_sword_28", "=q4=Bloodrazor", "=ds=#h1# #w10#" };
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
        ...
        { 810, "inv_hammer_11", "=q4=Hammer of the Northern Wind", "=ds=#h1# #w6#" };
	...
	BoEWorldEpics5060 = {
        ...
        { 1728, "inv_sword_22", "=q4=Teebu's Blazing Longsword", "=ds=#h1# #w10#" };
