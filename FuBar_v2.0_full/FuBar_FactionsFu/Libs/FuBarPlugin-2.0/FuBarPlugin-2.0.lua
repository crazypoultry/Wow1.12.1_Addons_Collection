...
local MINOR_VERSION = "$Revision: 8326 $"
...
function MinimapContainer:ReadjustLocation(plugin)
	...
	if not plugin.db or not plugin.db.profile.minimapPositionWild then
		local position = plugin.db and plugin.db.profile.minimapPosition or plugin.defaultMinimapPosition or math.random(1, 360)
