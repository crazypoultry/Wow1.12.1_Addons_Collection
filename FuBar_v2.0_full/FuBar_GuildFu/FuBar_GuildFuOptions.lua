	...
	type = "group", args = {
		...
		["tooltip"] = {
			type = "group", name = L["Tooltip"], desc = L["Tooltip Settings"], args = {
				["motd"] = {
					type = "group", name = L["MOTD"], desc = L["MOTD Settings"], args = {
						["show"] = {
							type = "toggle", name = L["Show"], desc = L["Toggles display of guild MOTD"],
							get = function() return FuBar_GuildFu.db.profile.tooltip.motd_show end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.motd_show = v; FuBar_GuildFu:UpdateTooltip() end,
							order = 1,
						},
					}, order = 1,
				},
				...
				["class"] = {
					type = "group", name = L["Class"], desc = L["Class Column Settings"], args = {
						...
						["align"] = {
							...
							get = function() return FuBar_GuildFu.db.profile.tooltip.class_align end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.class_align = v; FuBar_GuildFu:UpdateTooltip() end,
				...
				["level"] = {
					type = "group", name = L["Level"], desc = L["Level Column Settings"], args = {
						...
						["align"] = {
							...
							get = function() return FuBar_GuildFu.db.profile.tooltip.level_align end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.level_align = v; FuBar_GuildFu:UpdateTooltip() end,
							validate = {["LEFT"] = L["Left"], ["CENTER"] = L["Center"], ["RIGHT"] = L["Right"]},
							order = 2,
						},
						["color"] = {
				...
				["zone"] = {
					type = "group", name = L["Zone"], desc = L["Zone Column Settings"], args = {
						...
						["align"] = {
							...
							get = function() return FuBar_GuildFu.db.profile.tooltip.zone_align end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.zone_align = v; FuBar_GuildFu:UpdateTooltip() end,
							validate = {["LEFT"] = L["Left"], ["CENTER"] = L["Center"], ["RIGHT"] = L["Right"]},
							order = 2,
						},
						["color"] = {
				...
				["notes"] = {
					type = "group", name = L["Notes"], desc = L["Notes Column Settings"], args = {
						...
						["show_ctplayernotes"] = {
							...
							get = function() return FuBar_GuildFu.db.profile.tooltip.note_showctplayernotes end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.note_showctplayernotes = v; FuBar_GuildFu:UpdateTooltip() end,
							hidden = not IsAddOnLoaded("CT_PlayerNotes"),
							order = 4,
						},
						["align"] = {
							type = "text", name = L["Align"], desc = L["Sets alignment of notes column"],
							get = function() return FuBar_GuildFu.db.profile.tooltip.note_align end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.note_align = v; FuBar_GuildFu:UpdateTooltip() end,
							validate = {["LEFT"] = L["Left"], ["CENTER"] = L["Center"], ["RIGHT"] = L["Right"]},
							order = 5,
						},
					}, order = 8,
				...
				["rank"] = {
					type = "group", name = L["Rank"], desc = L["Rank Column Settings"], args = {
						...
						["align"] = {
							type = "text", name = L["Align"], desc = L["Sets alignment of rank column"],
							get = function() return FuBar_GuildFu.db.profile.tooltip.rank_align end,
							set = function(v) FuBar_GuildFu.db.profile.tooltip.rank_align = v; FuBar_GuildFu:UpdateTooltip() end,
							validate = {["LEFT"] = L["Left"], ["CENTER"] = L["Center"], ["RIGHT"] = L["Right"]},
							order = 2,
						},
					}, order = 9,
