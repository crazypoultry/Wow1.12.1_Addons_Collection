...
--[[
local DESC_CHARACTER = "Character: "
local DESC_REALM = "Realm: "
local DESC_CLASS = "Class: "
local DESC_DEFAULT = "Default"
local OPT_CHOOSE = "Choose"
local DESC_CHOOSE = "Choose a profile"
local OPT_COPY_FROM = "Copy from"
local DESC_COPY_FROM = "Copy settings from another profile"
local OPT_OTHER = "Other"
local DEST_OTHER = "Choose another profile"
local USAGE_OHTER = "<profile name>"
--]]
-- localize --
...
--[[
	...
	DESC_DEFAULT = "기본값"
	OPT_CHOOSE = "선택"
	DESC_CHOOSE = "프로파일을 선택합니다."
	OPT_COPY_FROM = "복사"
	DESC_COPY_FROM = "다른 케릭터의 프로파일을 복사합니다."
	OPT_OTHER = "기타"
	DEST_OTHER = "다른 프로파일을 선택합니다."
	USAGE_OHTER = "<프로파일명>"
--]]
end
...
--		t.char = DESC_CHARACTER .. charID
--		t.realm = DESC_REALM .. realmID
--		t.class = DESC_CLASS .. classID
--		t.Default = DESC_DEFAULT
		t.char = '캐릭터: ' .. charID
		t.realm = '서버: ' .. realmID
		t.class = '직업: ' .. classID
		t.Default = "기본값"
