...
SCT.LOCALS.OPTION_SLIDER101 = { name="공격력 X 좌표 위치", minText="-600", maxText="600", tooltipText = "메시지 중심축의 위치를 조정합니다."};
SCT.LOCALS.OPTION_SLIDER102 = { name="공격력 Y 좌표 위치", minText="-600", maxText="600", tooltipText = "메시지 중심축의 위치를 조정합니다."};
...
SCT.LOCALS.OPTION_SELECTION103 = { name="공격력 움직임 형태", tooltipText = "움직임 형태를 선택합니다. SCT와는 다른 형태를 선택해야 알아보기 쉬울 것입니다.", table = {[1] = "세로 (보통)",[2] = "무지개",[3] = "가로",[4] = "모나게 아래로",[5] = "모나게 위로",[6] = "스프링클러"}};
SCT.LOCALS.OPTION_SELECTION104 = { name="좌우 움직임 형태", tooltipText = "양쪽으로 스크롤되는 움직임 형태를 선택합니다.", table = {[1] = "교차",[2] = "공격력 왼쪽",[3] = "공격력 오른쪽", [4] = "모두 왼쪽", [5] = "모두 오른쪽"}};
