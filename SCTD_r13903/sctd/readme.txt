...
Please post all questions and comments on the offical SCTD thread.
...
1.1 - Made options frame its own LoadOnDemand mod, options frame is now moveable, added Color Crits options,
added ability to show only damage to your target, added ability to turn SCTD off and turn WoW damage on when 
in PvP and vice versa, added ability to use SCT animation for all damage, added better crit animations, various 
bug fixes and teaks.
1.0 - Initial Release 
