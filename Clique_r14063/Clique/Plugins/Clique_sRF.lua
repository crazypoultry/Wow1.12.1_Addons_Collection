...
local Plugin = Clique:NewModule("sraid")
Plugin.fullname = "sRaidFrames"
Plugin.url = "http://svn.wowace.com/wowace/trunk/sRaidFrames/"
...
function Plugin:OnEnable()
    sRaidFramesCustomOnClickFunction = self.OnClick
end
...
function Plugin:OnDisable()
    sRaidFramesCustomOnClickFunction = nil
end
