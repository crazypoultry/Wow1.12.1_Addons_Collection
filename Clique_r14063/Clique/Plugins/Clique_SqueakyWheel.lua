...
local Plugin = Clique:NewModule("squeaky")
Plugin.fullname = "Squeaky Wheel"
Plugin.url = "http://www.wowinterface.com/downloads/fileinfo.php?id=4277"
...
function Plugin:Test()
    return Squeaky_CustomOnClickFunction
end
...
function Plugin:OnEnable()
    Squeaky_CustomOnClickFunction = self.OnClick
end
...
function Plugin:OnDisable()
    Squeaky_CustomOnClickFunction = nil
end
