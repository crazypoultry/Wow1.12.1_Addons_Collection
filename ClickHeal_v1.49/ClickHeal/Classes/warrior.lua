...
CH_DEF_MOUSE_SPELLS = 
  { Friend    = {CtrlLeftButton={'ACTION','TARGET'},          CtrlMiddleButton={'PLUGIN','BANDAGE'},           CtrlRightButton={'ACTION','ASSIST'},
    ...
    EnemyDEF  = {CtrlLeftButton={'ACTION','TARGET'},          CtrlMiddleButton={'ACTION','USEWAND'},           CtrlRightButton={'ACTION','ATTACK'},
                 AltLeftButton={'ACTION','TOOLTIP'},                                                           AltRightButton={'ACTION','MENU'},
                },
    EnemyBAT  = {CtrlLeftButton={'ACTION','TARGET'},          CtrlMiddleButton={'ACTION','USEWAND'},           CtrlRightButton={'ACTION','ATTACK'},
                 AltLeftButton={'ACTION','TOOLTIP'},                                                           AltRightButton={'ACTION','MENU'},
                },
    EnemyBER  = {CtrlLeftButton={'ACTION','TARGET'},          CtrlMiddleButton={'ACTION','USEWAND'},           CtrlRightButton={'ACTION','ATTACK'},
                 AltLeftButton={'ACTION','TOOLTIP'},                                                           AltRightButton={'ACTION','MENU'},
                },
    Panic     = {
                },
...
CH_DEF_EXTRA_DATA = { Extra1 = { name=CH_WARRIOR_EXTRA1_LABEL, cooldownSpellName=nil,
                               },
                      Extra2 = { name=CH_WARRIOR_EXTRA2_LABEL, cooldownSpellName=nil,
                               },
                      Extra3 = { name=CH_WARRIOR_EXTRA3_LABEL, cooldownSpellName=nil,
                               },
                      Extra4 = { name=CH_WARRIOR_EXTRA4_LABEL, cooldownSpellName=nil,
                               },
                    };

CH_ACTION_TYPE_TEXT = { QUICK     = CH_WARRIOR_ACTION_TYPE_TEXT_QUICK,
                        HOT       = CH_WARRIOR_ACTION_TYPE_TEXT_HOT,
                        SLOW      = CH_WARRIOR_ACTION_TYPE_TEXT_SLOW,
                        SHIELD    = CH_WARRIOR_ACTION_TYPE_TEXT_SHIELD,
                        ...
                        USEWAND   = CH_WARRIOR_ACTION_TYPE_TEXT_USEWAND,
