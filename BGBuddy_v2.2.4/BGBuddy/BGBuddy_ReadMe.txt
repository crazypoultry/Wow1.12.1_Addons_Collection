-=-=-=-=-=-=-=-=-=-=-=-=-=-
=                         =
= BGBuddy-continued v2.2.3= by Wraal 
=                         = 
-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
+ Version 2.2.3
  -> Fixed the Join bg button not working when having multiple bg's queued.
  -> Addional formatting issues resolved.

+ Version 2.2.2
  -> Fixed some formatting issues inside of bgs

+ Version 2.2.1
  -> Fixed Join BG button			07/21/2006
