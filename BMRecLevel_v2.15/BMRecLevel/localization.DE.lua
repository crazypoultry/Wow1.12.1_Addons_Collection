function BM_Translation_DE()
	...
	BRL_RESET_ALL_TEXT						= "Willst du wirklich alle Einstellungen zur\195\188cksetzen?";
	BRL_CITY								= "Stadt";
	...
	-- *** MENU OPTIONS *** --
	BRL_ZONE_INFO_ENABLE					= "Zoneninfo-Leiste anzeigen/verstecken";
	BRL_TOOLTIP_ENABLE						= "Tooltip anzeigen/verstecken";
	BRL_MAP_TEXT_ENABLE					= "Zoneninfo auf der Weltkarte anzeigen/verstecken";
	...
	BRL_SHOW_ZONE							= "Zone in der Leiste anzeigen";
	BRL_SHOW_REC_INSTANCE				= "Empfohlene Instanzen anzeigen";
	BRL_SHOW_REC_BATTLEGROUNDS			= "Empfohlene Schlachtfelder anzeigen";
	...
	INSTANCE_TABLE = {
				...
				["silithus_instances"]			= {
												{["itype"] = "instance", ["instance"] = "Ruinen von Ahn'Qiraj", ["low_level"] = 60, ["high_level"] = 60, ["faction"] = BRL_NONE},
												{["itype"] = "instance", ["instance"] = "Tore von Ahn'Qiraj", ["low_level"] = 60, ["high_level"] = 60, ["faction"] = BRL_NONE},
											},
