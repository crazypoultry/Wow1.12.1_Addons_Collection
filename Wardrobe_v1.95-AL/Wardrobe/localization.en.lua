...
--Localization.RegisterGlobalAddonStrings("enUS", "Wardrobe", {
	...
	BINDING_NAME_WARDROBE_AUTO_SWAP_BINDING = "Toggle Auto Swaps";
...
WardrobeText["enUS"] = {
	...
	CONFIG_AUTOSWAP				= "Auto Swap";
	CONFIG_AUTOSWAP_INFO		= "Allow special outifts to automaticly swap.";
	...
	TXT_AUTO_ENABLED           = "Auto Swaps Enabled.";
	TXT_AUTO_DISABLED          = "Auto Swaps Disabled.";
