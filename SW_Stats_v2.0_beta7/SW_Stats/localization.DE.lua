...
-- 2.0 New strings LOCALIZE
	...
	SW_DS_JOINED_GROUP = "Gruppe beigetreten";
	SW_DS_LEFT_GROUP = "Gruppe verlassen";
	SW_DS_JOINED_RAID = "Schlachtgruppe beigetreten";
	SW_DS_LEFT_RAID = "Schlachtgruppe verlassen";
	-- not used yet
	...
	SW_STR_ENVIRO = "Umgebung";
	
	SW_CL_SHOOT = "Schießen"; -- the Wand "Shoot" ability as found in the combat log
	
-- 2.0 New strigs LOCALIZE END
...
--popups
StaticPopupDialogs["SW_Reset"]["text"] = "Sollen wirklich ein neues Segment erstellt werden?"
...
StaticPopupDialogs["SW_ResetSync"]["text"] = "Ihr seid in einem SyncChannel. Alle sich im Sync befindenden Spieler werden ein neues Segemnt erstellen. Wollt Ihr das wirklich?";
...
SW_MiniIconMenu[8]["text"] = "Daten Reset";
