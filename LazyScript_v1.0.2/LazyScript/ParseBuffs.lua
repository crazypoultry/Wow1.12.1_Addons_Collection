...
function lazyScript.loadBuffTable()
   if not lazyScript.getLocaleString("BUFF_TTS", false, true) then
      lazyScript.p("Optimized buff/debuff checking is not available for your locale. You will have to use ifHasBuffTitle, ifHasDebuffTitle, etc. instead.")
...
function lazyScript.masks.CheckBuffOrDebuff(unitId, buffObj, buffType, gtLtEq, val)
   return function(sayNothing)
      ...
      if (not sayNothing) then
         lazyScript.d("Looking for: "..(buffObj.name or "nil").." buffId: "..(buffId or "nil").." Applications: "..(buffApplications or "nil"))
      end
   ...
   for buffName in string.gfind(buffNames, "[^,]+") do
      ...
      for key, obj in pairs(lazyScript.buffTable) do
         ...
         if (key == buffName) then
            lazyScript.d("Buff info found for: "..buffName.."." )
            buffObj = obj
            break
         end
      end
      ...
      if (buffObj == nil) then
         ...
         lazyScript.p("Did not find "..buffName.." in the "..buffType.." database. Try "..tempString.." instead.")
         return nil
      end
...
function lazyScript.masks.CheckBuffOrDebuffTitle(unitId, buffName, buffType, gtLtEq, val)
   return function(sayNothing)
      ...
      if (not sayNothing) then
         lazyScript.d("Looking for: "..(buffName or "nil").." buffId: "..(buffId or "nil").." Applications: "..(buffApplications or "nil"))
      end
...
function lazyScript.bitParsers.ifBuffDuration(bit, actions, masks)
   ...
   for buffName in string.gfind(buffNames, "[^,]+") do
      ...
      for key, obj in pairs(lazyScript.buffTable) do
         -- Search by shortName
         if (key == buffName) then
            lazyScript.d("Found known buff: "..buffName)
            buffObj = obj
            break
         end
      end
...
--         lazyScript.d("Function Is"..debuffType.." found.")
         ...
         lazyScript.p("Buff/debuff category "..debuffType.." not recognised.")
         return nil
      end
            ...
            if (buffResult ~= nil) then
               if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
                  if (not buffobj.name) then
                     if (not sayNothing) then
                        lazyScript.p("ifCCd: "..unitId.." afflicted by "..buffobj.texture)
                     end
                  else
                     if (not sayNothing) then
                        lazyScript.p("ifCCd: "..unitId.." afflicted by "..buffobj.name)
                     end
                  end
               end
      ...
      if (buffs ~= nil) then
         for idx, buffobj in ipairs(buffs) do
            ...
            if (buffResult ~= nil) then
               if (not buffobj.name) then
                  if (not sayNothing) then
                     lazyScript.d("ifPolyMorphed: "..unitId.." afflicted by "..buffobj.texture)
                  end
               else
                  if (not sayNothing) then
                     lazyScript.d("ifPolyMorphed: "..unitId.." afflicted by "..buffobj.name)
                  end
               end
               return true
            end
      ...
      if (buffs ~= nil) then
         for idx, buffobj in ipairs(buffs) do
            ...
            if (buffResult ~= nil) then
               ...
               if (not buffobj.name) then
                  if (not sayNothing) then
                     lazyScript.d("ifBleeding: "..unitId.." afflicted by "..buffobj.texture)
                  end
               else
                  if (not sayNothing) then
                     lazyScript.d("ifBleeding: "..unitId.." afflicted by "..buffobj.name)
                  end
               end
               return true
            end
      ...
      if (buffs ~= nil) then
         for idx, buffobj in ipairs(buffs) do
            ...
            if (buffResult ~= nil) then
               if (not buffobj.name) then
                  if (not sayNothing) then
                     lazyScript.d("ifCharmed: "..unitId.." afflicted by "..buffobj.texture)
                  end
               else
                  if (not sayNothing) then
                     lazyScript.d("ifCharmed: "..unitId.." afflicted by "..buffobj.name)
                  end
               end
               return true
            end
      ...
      if (buffs ~= nil) then
         for idx, buffobj in ipairs(buffs) do
            ...
            if (buffResult ~= nil) then
               if (not buffobj.name) then
                  if (not sayNothing) then
                     lazyScript.d("ifEating: "..unitId.." afflicted by "..buffobj.texture)
                  end
               else
                  if (not sayNothing) then
                     lazyScript.d("ifEating: "..unitId.." afflicted by "..buffobj.name)
                  end
               end
               return true
            end
      ...
      if (buffs ~= nil) then
         for idx, buffobj in ipairs(buffs) do
            ...
            if (buffResult ~= nil) then
               if (not buffobj.name) then
                  if (not sayNothing) then
                     lazyScript.d("ifDrinking: "..unitId.." afflicted by "..buffobj.texture)
                  end
               else
                  if (not sayNothing) then
                     lazyScript.d("ifDrinking: "..unitId.." afflicted by "..buffobj.name)
                  end
               end
               return true
            end
...
function lazyScript.masks.IsDotted(unitId)
   ...
   if (not dotted) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifDotted not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(dotted) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifDotted: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsSlowed(unitId)
   ...
   if (not slowed) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifSlowed not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(slowed) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifSlowed: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsStunned(unitId)
   ...
   if (not stunned) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifStunned not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(stunned) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifStunned: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsFeared(unitId)
   ...
   if (not feared) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifFeared not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(feared) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifFeared: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsImmobile(unitId)
   ...
   if (not immobile) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifImmobile not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(immobile) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifImmobile: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsAsleep(unitId)
   ...
   if (not asleepStrings) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifAsleep not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(asleepStrings) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifAsleep: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsDisoriented(unitId)
   ...
   if (not disorientedStrings) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifDisoriented not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(disorientedStrings) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifDisoriented: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.IsIncapacitated(unitId)
   ...
   if (not incapacitatedStrings) then
      if (not sayNothing) then
         lazyScript.p("Sorry, ifIncapacitated not supported for your locale.")
      end
      return false
   end
   ...
   return function(sayNothing)
      for idx, ttBody in ipairs(incapacitatedStrings) do
         if (lazyScript.masks.HasBuffOrDebuff(unitId, "debuff", nil, nil, ttBody, sayNothing)) then
            if (lazyScript.perPlayerConf.showReasonForTargetCCd) then
               if (not sayNothing) then
                  lazyScript.d("ifIncapacitated: "..unitId.." afflicted by "..ttBody)
               end
            end
            return true
         end
...
function lazyScript.masks.FindBuffsByCategory(category)
   ...
   if (table.getn(buffs) == 0) then
      lazyScript.d("Did not find any buffs in the "..category.." category.")
      return nil
   end
